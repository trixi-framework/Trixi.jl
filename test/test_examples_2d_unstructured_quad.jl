...
@testset "Unstructured Curve Mesh for Euler" begin
  ...
  @testset "elixir_mhd_unstructured_quad_ec.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_unstructured_quad_ec.jl"),
      l2   = [0.07056517809022632, 0.08116980673562882, 0.0811555336002286, 0.05364053868141791,
              0.22703748172281382, 0.023849564706085274, 0.023853812431846762, 0.04203061166395393,
              0.0011826886138914443],
      linf = [0.18336528888036496, 0.35344817817976226, 0.3511574361818761, 0.1647815192354763,
              0.666836933685043, 0.07959673590407457, 0.07961839433870721, 0.21459916069054463,
