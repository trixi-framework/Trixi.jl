...
@safetestset "Unstructured Curve Mesh for Euler" begin

  @safetestset "elixir_euler_unstructured_quad_periodic.jl" begin
  ...
  @safetestset "elixir_euler_unstructured_quad_free_stream.jl" begin
  ...
  @safetestset "elixir_euler_unstructured_quad_wall_bc.jl" begin
  ...
  @safetestset "elixir_euler_unstructured_quad_basic.jl" begin
  ...
  @safetestset "elixir_euler_unstructured_quad_basic_restart.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_unstructured_quad_basic_restart.jl"),
      l2   = [0.0007258658867098887, 0.000676268065087451, 0.0006316238024054346, 0.0014729738442086392],
      linf = [0.004476908674416524, 0.0052614635050272085, 0.004926298866533951, 0.018058026023565432])
  end

  @safetestset "elixir_euler_unstructured_quad_ec.jl" begin
  ...
  @safetestset "elixir_advection_unstructured_quad_basic.jl" begin
  ...
  @safetestset "elixir_ape_unstructured_quad_gauss_wall.jl" begin
  ...
  @safetestset "elixir_mhd_unstructured_quad_ec.jl" begin
  ...
  @safetestset "elixir_mhd_unstructured_quad_alfven_wave.jl" begin
