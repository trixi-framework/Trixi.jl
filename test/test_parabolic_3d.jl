...
@trixi_testset "P4estMesh3D: elixir_advection_diffusion_amr_unstructured_curved.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "p4est_3d_dgsem",
                        ...
                        l2=[0.00023552239536337634], linf=[0.012186740279098496],
                        tspan=(0.0, 1.0))
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
...
@trixi_testset "P4estMesh3D: elixir_navierstokes_blast_wave_amr.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "p4est_3d_dgsem",
                        ...
                        tspan=(0.0, 0.01),
                        l2=[
                            0.009472104410520866,
                            0.001788378076420436,
                            0.0017883780764204344,
                            0.001788378076420434,
                            0.024388539218400503
                        ],
                        linf=[
                            0.6782397166514129,
                            0.17663690224376827,
...
@trixi_testset "P4estMesh3D: elixir_navierstokes_blast_wave_amr.jl (LDG)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "p4est_3d_dgsem",
                                 "elixir_navierstokes_blast_wave_amr.jl"),
                        tspan=(0.0, 0.01),
                        solver_parabolic=ViscousFormulationLocalDG(),
                        l2=[
                            0.009471440830394688,
                            0.0017855153696784136,
                            0.0017855153696784093,
                            0.001785515369678418,
                            0.024384521407261953
                        ],
                        linf=[
                            0.6788328356527554,
                            0.1761756901901707,
