...
@trixi_testset "TreeMesh3D: elixir_navierstokes_taylor_green_vortex.jl" begin
    @test_trixi_include(joinpath(examples_dir(), "tree_3d_dgsem",
                        ...
                        l2=[0.00024173250389635442,
                            0.015684268393762454,
                            0.01568426839376248,
                            0.021991909545192333,
                            0.02825413672911425],
                        linf=[0.0008410587892853094,
                              0.04740176181772552,
                              0.04740176181772507,
                              0.07483494924031157,
                              0.150181591534448])
...
@trixi_testset "P4estMesh3D: elixir_navierstokes_taylor_green_vortex_amr.jl" begin
    @test_trixi_include(joinpath(examples_dir(), "p4est_3d_dgsem",
                        ...
                        l2=[0.0016588740573444188,
                            0.03437058632045721,
                            0.03437058632045671,
                            0.041038898400430075,
                            0.30978593009044153],
                        linf=[0.004173569912012121,
                              0.09168674832979556,
                              0.09168674832975021,
                              0.12129218723807476,
                              0.8433893297612087])
...
@trixi_testset "P4estMesh3D: elixir_navierstokes_blast_wave_amr.jl" begin
    @test_trixi_include(joinpath(examples_dir(), "p4est_3d_dgsem",
                        ...
                        tspan=(0.0, 0.01),
                        l2=[0.009472104410520866, 0.0017883742549557149,
                            0.0017883742549557147, 0.0017883742549557196,
                            0.024388540048562748],
                        linf=[0.6782397526873181, 0.17663702154066238,
                              0.17663702154066266, 0.17663702154066238,
                              1.7327849844825238])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    let
