...
@testset "Curved mesh" begin
  ...
  @testset "elixir_euler_ec_curved.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_ec_curved.jl"),
      l2   = [0.009075682172462964, 0.006520654093283988, 0.006278205774790491, 0.006330280041515624, 0.0230413725355302],
      linf = [0.19845692344168608, 0.2195200417620209, 0.22453708259891553, 0.22350874067708754, 0.4288300827875553],
      tspan = (0.0, 0.5))
  end
