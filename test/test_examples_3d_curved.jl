...
@testset "Curved mesh" begin
  ...
  @testset "elixir_euler_cubed_sphere.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_cubed_sphere.jl"),
      l2   = [0.0007265848058616628, 0.0006833859385246015, 0.0006833859385245764, 0.0006833859385245513, 0.00130543613416062],
      linf = [0.006504238032226883, 0.006720619558554741, 0.006764317343874282, 0.006764317343875614, 0.013828373404594974])
  end
end
