...
@testset "MHD" begin
    ...
    @trixi_testset "elixir_mhd_briowu_shock_tube.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_briowu_shock_tube.jl"),
            l2 = [
                0.17477712356961989,
                0.19489623595086944,
                0.3596546157640463,
    ...
    @trixi_testset "elixir_mhd_torrilhon_shock_tube.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_torrilhon_shock_tube.jl"),
            l2 = [
                0.45700904847931145,
                0.4792535936512035,
                0.340651203521865,
    ...
    @trixi_testset "elixir_mhd_ryujones_shock_tube.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_ryujones_shock_tube.jl"),
            l2 = [
                0.23469781891518154,
                0.3916675299696121,
                0.08245195301016353,
    ...
    @trixi_testset "elixir_mhd_shu_osher_shock_tube.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_shu_osher_shock_tube.jl"),
            l2 = [
                1.0112621e+0,
                8.27157902e+0,
                1.30882545e+0,
