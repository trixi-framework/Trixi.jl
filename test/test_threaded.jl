@testsnippet ThreadedExamples begin
    EXAMPLES_DIR = examples_dir()
end

@testitem "Threaded TreeMesh: elixir_advection_restart.jl" setup=[Setup, ThreadedExamples] tags=[:threaded] begin
...
@testitem "Threaded TreeMesh: elixir_advection_restart.jl with adaptive time integration" setup=[
    Setup,
    ThreadedExamples
] tags=[:threaded] begin
...
@testitem "Threaded TreeMesh: elixir_advection_restart.jl with threaded time integration" setup=[
    Setup,
    ThreadedExamples
] tags=[:threaded] begin
...
@testitem "Threaded TreeMesh: elixir_advection_amr_refine_twice.jl" setup=[
    Setup,
    ThreadedExamples
] tags=[:threaded] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "tree_2d_dgsem",
...
@testitem "Threaded TreeMesh: elixir_euler_ec.jl" setup=[Setup, ThreadedExamples] tags=[:threaded] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "tree_2d_dgsem",
                                 "elixir_euler_ec.jl"),
                        l2=[
...
@testitem "Threaded TreeMesh: elixir_advection_diffusion.jl" setup=[Setup, ThreadedExamples] tags=[:threaded] begin
    using OrdinaryDiffEqLowStorageRK: RDPK3SpFSAL49
    @test_trixi_include(joinpath(EXAMPLES_DIR, "tree_2d_dgsem",
...
@testitem "Threaded StructuredMesh: elixir_advection_restart.jl with waving flag mesh" setup=[
    Setup,
    ThreadedExamples
] tags=[:threaded] begin
...
@testitem "Threaded P4estMesh: elixir_eulergravity_convergence.jl" setup=[
    Setup,
    ThreadedExamples
] tags=[:threaded] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "p4est_2d_dgsem",
...
@testitem "Threaded T8codeMesh: elixir_euler_source_terms_nonconforming_unstructured_flag.jl" setup=[
    Setup,
    ThreadedExamples
] tags=[:threaded] begin
...
@testitem "Threaded T8codeMesh: elixir_eulergravity_convergence.jl" setup=[
    Setup,
    ThreadedExamples
] tags=[:threaded] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "t8code_2d_dgsem",
...
@testitem "Threaded DGMulti: elixir_euler_weakform.jl (SBP, EC)" setup=[
    Setup,
    ThreadedExamples
] tags=[:threaded] begin
