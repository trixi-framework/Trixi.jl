...
@safetestset "Compressible Euler Multicomponent" begin
  ...
  @safetestset "elixir_eulermulti_shock_bubble.jl" begin
  ...
  @safetestset "elixir_eulermulti_shock_bubble_3components.jl" begin
  ...
  @safetestset "elixir_eulermulti_shock_bubble_7components.jl" begin
  ...
  @safetestset "elixir_eulermulti_ec.jl" begin
  ...
  @safetestset "elixir_eulermulti_es.jl" begin
  ...
  @safetestset "elixir_eulermulti_eoc_ec.jl" begin
  ...
  @safetestset "elixir_eulermulti_eoc_es.jl" begin
