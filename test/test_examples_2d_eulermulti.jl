...
@testset "Compressible Euler Multicomponent" begin
  ...
  @testset "elixir_eulermulti_ec.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_eulermulti_ec.jl"),
      l2   = [5.01948074e-02, 5.02023248e-02, 2.25886833e-01, 2.05762155e-02, 4.11524309e-02],
      linf = [3.06937711e-01, 3.06807092e-01, 1.06295287e+00, 9.93785749e-02, 1.98757150e-01])
  end

  @testset "elixir_eulermulti_es.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_eulermulti_es.jl"),
      l2   = [4.96608585e-02, 4.96617550e-02, 2.24265059e-01, 2.04342800e-02, 4.08685600e-02],
      linf = [2.48820395e-01, 2.48311640e-01, 9.35790843e-01, 8.62874949e-02, 1.72574990e-01])
  end
