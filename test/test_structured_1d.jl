...
@testset "StructuredMesh1D" begin
    ...
    @trixi_testset "elixir_advection_shockcapturing.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_shockcapturing.jl"),
    ...
    @trixi_testset "elixir_euler_sedov.jl" begin
        @test_trixi_include(
            ...
            l2 = [3.67478226e-1, 3.49491179e-1, 8.08910759e-1],
            linf = [1.58971947e+0, 1.59812384e+0, 1.94732969e+0],
            tspan = (0.0, 0.3)
        )
        # Ensure that we do not have excessive memory allocations
        # (e.g., from type instabilities)
    ...
    @trixi_testset "elixir_euler_convergence_pure_fv.jl" begin
        @test_trixi_include(
            joinpath(
                pkgdir(Trixi, "examples", "tree_1d_dgsem"),
