...
@testset "StructuredMesh1D" begin
  ...
  @trixi_testset "elixir_advection_composite.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_composite.jl"),
      l2   = [0.0630105298116176],
      linf = [0.5884019851242106])
  end
