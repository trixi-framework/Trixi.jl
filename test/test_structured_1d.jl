...
@trixi_testset "elixir_mhd_alfwen_wave_flux_reconstruction.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
                        ...
                        l2=[
                            0.00012317886436942515,
                            6.20868630632875e-7,
                            9.650638616603783e-6,
                            9.650638616606959e-6,
                            3.837964018004209e-7,
                            1.196322416573199e-16,
                            2.2462296517288713e-6,
                            2.246229651706109e-6
                        ],
                        linf=[
                            0.00045612584288157176,
                            1.7878748471813997e-6,
                            4.679013837376178e-5,
                            4.994932746250902e-5,
                            1.0701063897222696e-6,
                            2.220446049250313e-16,
                            7.1663584750719656e-6,
                            8.121237634120537e-6
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
