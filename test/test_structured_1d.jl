...
@trixi_testset "elixir_mhd_alfwen_wave_flux_reconstruction.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
                        ...
                        l2=[
                            0.00010037221078909425,
                            5.213500315987378e-7,
                            7.355116742155434e-6,
                            7.3551167399527096e-6,
                            4.908915221553284e-7,
                            4.130462730493992e-17,
                            6.92946917402171e-7,
                            6.929469311887592e-7
                        ],
                        linf=[
                            0.00013308059722150212,
                            1.1694084820764926e-6,
                            1.4121813380799098e-5,
                            1.4121741048839231e-5,
                            6.569774994025224e-7,
                            1.1102230246251565e-16,
                            3.127055734797324e-6,
                            3.1275373087169545e-6
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
