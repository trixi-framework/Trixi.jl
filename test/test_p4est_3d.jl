...
@testset "P4estMesh3D" begin
  ...
  @trixi_testset "elixir_euler_ec.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_ec.jl"),
      l2   = [0.009229812155738561, 0.00709044312928727, 0.007424585922056653, 0.007435989920914005, 0.023361529941585756],
      linf = [0.17369495416443836, 0.25588109930175085, 0.25472582845455266, 0.2744523327743227, 0.4274787326285612])
  end
end
