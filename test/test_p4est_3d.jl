...
@testset "P4estMesh3D" begin
    ...
    @trixi_testset "elixir_advection_nonconforming.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_nonconforming.jl"),
    ...
    @trixi_testset "elixir_advection_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_amr.jl"),
            # Expected errors are exactly the same as with TreeMesh!
            l2 = [9.773852895157622e-6],
            linf = [0.0005853874124926162],
            coverage_override = (
                maxiters = 6, initial_refinement_level = 1,
    ...
    @trixi_testset "elixir_advection_amr_unstructured_curved.jl" begin
        @test_trixi_include(
            ...
            tspan = (0.0, 1.0),
            coverage_override = (
                maxiters = 6, initial_refinement_level = 0,
    ...
    @trixi_testset "elixir_advection_cubed_sphere.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_cubed_sphere.jl"),
    ...
    @trixi_testset "elixir_euler_free_stream_extruded.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_free_stream_extruded.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_mhd_alfven_wave_nonconforming.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                0.00019018725889431733, 0.0006523517707148006,
            ...
            linf = [
                0.0012482306861187897, 0.006408776208178299,
    ...
    @trixi_testset "elixir_mhd_shockcapturing_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_shockcapturing_amr.jl"),
            l2 = [
                0.006297229188299052, 0.0064363477630573936,
            ...
            linf = [
                0.20904050617411984, 0.18630026905465372,
    ...
    @trixi_testset "elixir_euler_weak_blast_wave_amr.jl" begin
        ...
        @test isapprox(state_integrals[5], initial_state_integrals[5], atol = 1.0e-13)
    end
end
