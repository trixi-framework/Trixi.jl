@testsnippet TreeMesh2DFDSBP begin
    EXAMPLES_DIR = joinpath(examples_dir(), "tree_2d_fdsbp")
end

@testitem "TreeMesh2D FDSBP: elixir_advection_extended.jl" setup=[Setup, TreeMesh2DFDSBP] tags=[:tree_part3] begin
...
@testitem "TreeMesh2D FDSBP: elixir_advection_extended.jl with periodic operators" setup=[
    Setup,
    TreeMesh2DFDSBP
...
@testitem "TreeMesh2D FDSBP: elixir_euler_convergence.jl" setup=[Setup, TreeMesh2DFDSBP] tags=[:tree_part3] begin
...
@testitem "TreeMesh2D FDSBP: elixir_euler_convergence.jl with Lax-Friedrichs splitting" setup=[
    Setup,
    TreeMesh2DFDSBP
] tags=[:tree_part3] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_convergence.jl"),
...
@testitem "TreeMesh2D FDSBP: elixir_euler_convergence.jl with Drikakis-Tsangaris splitting" setup=[
    Setup,
    TreeMesh2DFDSBP
] tags=[:tree_part3] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_convergence.jl"),
...
@testitem "TreeMesh2D FDSBP: elixir_euler_convergence_flux_diff.jl" setup=[
    Setup,
    TreeMesh2DFDSBP
] tags=[:tree_part3] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_convergence_flux_diff.jl"),
                        l2=[
                            5.936821535586292e-7,
                            6.391809117520006e-7,
                            6.391809117121754e-7,
                            1.4424798920059498e-6
                        ],
                        linf=[
                            1.8258639695734047e-6,
                            2.071509331180721e-6,
                            2.071509333845256e-6,
                            4.9926398344446454e-6
                        ],
                        tspan=(0.0, 0.1))
...
@testitem "TreeMesh2D FDSBP: elixir_euler_vortex.jl" setup=[Setup, TreeMesh2DFDSBP] tags=[:tree_part3] begin
