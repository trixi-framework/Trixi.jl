...
@testset "T8codeMesh2D" begin
  ...
  @trixi_testset "elixir_mhd_rotor.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_rotor.jl"),
      l2   = [0.44211360369891683, 0.8805178316216257, 0.8262710688468049, 0.0,
              0.9616090460973586, 0.10386643568745411, 0.15403457366543802, 0.0,
              2.8399715649715473e-5],
      linf = [10.04369305341599, 17.995640564998403, 9.576041548174265, 0.0,
              19.429658884314534, 1.3821395681242314, 1.818559351543182, 0.0,
