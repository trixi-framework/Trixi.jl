...
@testset "T8codeMesh2D" begin
    ...
    @trixi_testset "test check_for_negative_volumes" begin
        @test_throws "Discovered negative volumes" begin
            ...
            mesh_file = Trixi.download(
                "https://gist.githubusercontent.com/jmark/bfe0d45f8e369298d6cc637733819013/raw/cecf86edecc736e8b3e06e354c494b2052d41f7a/rectangle_with_negative_volumes.msh",
                joinpath(
                    EXAMPLES_DIR,
    ...
    @trixi_testset "test t8code mesh from ABAQUS HOHQMesh file" begin
        @test begin
            ...
            file_path = Trixi.download(
                "https://gist.githubusercontent.com/jmark/9e0da4306e266617eeb19bc56b0e7feb/raw/e6856e1deb648a807f6bb6d6dcacff9e55d94e2a/round_2d_tank.inp",
    ...
    @trixi_testset "elixir_mhd_rotor.jl" begin
        ...
        @test_trixi_include(
            ...
            l2 = [
                0.44207324634847545, 0.8804644301177857, 0.8262542320669426,
                0.0,
            ...
            linf = [
                10.04548675437385, 17.998696852394836, 9.575802136190026,
                0.0,
