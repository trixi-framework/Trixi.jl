...
@testset "MHD" begin
  ...
  @trixi_testset "elixir_mhd_briowu_shock_tube.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_briowu_shock_tube.jl"),
      l2   = [0.1799676692573806, 0.19769924610977316, 0.36550002940919335, 0.0, 0.3783292232203961, 6.601687006712401e-16, 0.3653012678594631, 0.0],
      linf = [0.551833684767183, 0.4391822369623736, 1.099779104181865, 0.0, 1.0518732063432532, 2.6645352591003757e-15, 1.5414328474098955, 0.0])
  end
