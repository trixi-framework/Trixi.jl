...
@testset "MHD" begin
  ...
  @trixi_testset "elixir_mhd_briowu_shock_tube.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_briowu_shock_tube.jl"),
      l2   = [0.17996765122001343, 0.19769923644263276, 0.36549997759197134, 0.0, 0.3783292098600201, 6.601687006712401e-16, 0.36530124628367555, 0.0],
      linf = [0.5518328844347977, 0.4391823372018718, 1.0997780871997873, 0.0, 1.0518705176809253, 2.6645352591003757e-15, 1.5414318574064647, 0.0])
  end
