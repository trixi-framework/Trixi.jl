...
@safetestset "MHD" begin
  ...
  @safetestset "elixir_mhd_alfven_wave.jl with initial_condition_constant" begin
  ...
  @safetestset "elixir_mhd_alfven_wave.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_alfven_wave.jl"),
  ...
  @safetestset "elixir_mhd_ec.jl" begin
  ...
  @safetestset "elixir_mhd_briowu_shock_tube.jl" begin
  ...
  @safetestset "elixir_mhd_torrilhon_shock_tube.jl" begin
  ...
  @safetestset "elixir_mhd_ryujones_shock_tube.jl" begin
  ...
  @safetestset "elixir_mhd_shu_osher_shock_tube.jl" begin
  ...
  @safetestset "elixir_mhd_shu_osher_shock_tube.jl with flipped shock direction" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_shu_osher_shock_tube.jl"),
