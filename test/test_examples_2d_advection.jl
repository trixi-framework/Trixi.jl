...
@safetestset "Linear scalar advection" begin
  ...
  @safetestset "elixir_advection_extended.jl with polydeg=1" begin
  ...
  @safetestset "elixir_advection_restart.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_restart.jl"),
      l2   = [1.2148032454832534e-5],
      linf = [6.495644795245781e-5])
  end

  @safetestset "elixir_advection_mortar.jl" begin
  ...
  @safetestset "elixir_advection_amr_solution_independent.jl" begin
  ...
  @safetestset "elixir_advection_amr_visualization.jl" begin
  ...
  @safetestset "elixir_advection_timeintegration.jl" begin
  ...
  @safetestset "elixir_advection_timeintegration.jl with carpenter_kennedy_erk43" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_timeintegration.jl"),
  ...
  @safetestset "elixir_advection_timeintegration.jl with carpenter_kennedy_erk43 with maxiters=1" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_timeintegration.jl"),
  ...
  @safetestset "elixir_advection_timeintegration.jl with parsani_ketcheson_deconinck_erk94" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_timeintegration.jl"),
  ...
  @safetestset "elixir_advection_timeintegration.jl with parsani_ketcheson_deconinck_erk32" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_timeintegration.jl"),
  ...
  @safetestset "elixir_advection_timeintegration.jl with parsani_ketcheson_deconinck_erk32 with maxiters=1" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_timeintegration.jl"),
  ...
  @safetestset "elixir_advection_callbacks.jl" begin
