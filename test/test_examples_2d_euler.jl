...
@safetestset "Compressible Euler" begin
  @safetestset "elixir_euler_source_terms.jl" begin
  ...
  @safetestset "elixir_euler_convergence_test_pure_fv.jl" begin
  ...
  @safetestset "elixir_euler_density_wave.jl" begin
  ...
  @safetestset "elixir_euler_nonperiodic.jl" begin
  ...
  @safetestset "elixir_euler_ec.jl" begin
  ...
  @safetestset "elixir_euler_shockcapturing.jl" begin
  ...
  @safetestset "elixir_euler_blast_wave.jl" begin
  ...
  @safetestset "elixir_euler_blast_wave_pure_fv.jl" begin
  ...
  @safetestset "elixir_euler_blast_wave_amr.jl" begin
  ...
  @safetestset "elixir_euler_sedov_blast_wave.jl" begin
  ...
  @safetestset "elixir_euler_positivity.jl" begin
  ...
  @safetestset "elixir_euler_blob_mortar.jl" begin
  ...
  @safetestset "elixir_euler_blob_amr.jl" begin
  ...
  @safetestset "elixir_euler_kelvin_helmholtz_instability.jl" begin
  ...
  @safetestset "elixir_euler_kelvin_helmholtz_instability_amr.jl" begin
    if Threads.nthreads() == 1
      # This example uses random numbers to generate the initial condition.
      # Hence, we can only check "errors" if everything is made reproducible.
      # However, that's not enough to ensure reproducibility since the stream
  ...
  @safetestset "elixir_euler_vortex.jl" begin
  ...
  @safetestset "elixir_euler_vortex_mortar.jl" begin
  ...
  @safetestset "elixir_euler_vortex_mortar_split.jl" begin
  ...
  @safetestset "elixir_euler_vortex_mortar_split.jl with flux_central" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_vortex_mortar_split.jl"),
  ...
  @safetestset "elixir_euler_vortex_mortar_split.jl with flux_shima_etal" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_vortex_mortar_split.jl"),
  ...
  @safetestset "elixir_euler_vortex_mortar_split.jl with flux_ranocha" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_vortex_mortar_split.jl"),
  ...
  @safetestset "elixir_euler_vortex_shockcapturing.jl" begin
  ...
  @safetestset "elixir_euler_vortex_mortar_shockcapturing.jl" begin
  ...
  @safetestset "elixir_euler_vortex_amr.jl" begin
