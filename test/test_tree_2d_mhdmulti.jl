...
@testset "MHD Multicomponent" begin
    ...
    @trixi_testset "elixir_mhdmulti_ec.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhdmulti_ec.jl"),
            l2 = [
                0.04300299195675897, 0.042987505670835945,
            ...
            linf = [
                0.31371522041799105, 0.3037839783173047,
    ...
    @trixi_testset "elixir_mhdmulti_ec.jl with flux_derigs_etal" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhdmulti_ec.jl"),
            l2 = [
                0.04301155595653799, 0.04299735787276207,
            ...
            linf = [
                0.3156206778985397, 0.30941696929809526,
                0.21167563519254176,
    ...
    @trixi_testset "elixir_mhdmulti_es.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhdmulti_es.jl"),
            l2 = [
                0.042511527162267, 0.04250603277530184, 0.02385422747993974,
                0.11555081362726903,
            ...
            linf = [
                0.23454607703107877, 0.23464789247380322,
    ...
    @trixi_testset "elixir_mhdmulti_convergence.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhdmulti_convergence.jl"),
            l2 = [
                0.0003808877028249613, 0.0003808877028249593,
            ...
            linf = [
                0.0013324014301672943, 0.0013324014301669181,
    ...
    @trixi_testset "elixir_mhdmulti_rotor.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhdmulti_rotor.jl"),
            l2 = [
                0.6574605535168556, 0.6623234319361953, 0.0,
                0.689806698245354,
            ...
            linf = [
                9.362339085941425, 9.169838118652539, 0.0,
                10.600957847359556,
