...
@safetestset "Examples 2D" begin
  ...
  @safetestset "elixir_advection_amr_refine_twice.jl" begin
  ...
  @safetestset "elixir_advection_amr_coarsen_twice.jl" begin
  ...
  @safetestset "elixir_hypdiff_lax_friedrichs.jl" begin
  ...
  @safetestset "elixir_hypdiff_harmonic_nonperiodic.jl" begin
  ...
  @safetestset "elixir_hypdiff_nonperiodic.jl" begin
  ...
  @safetestset "elixir_hypdiff_godunov.jl" begin
  ...
  @safetestset "elixir_euler_source_terms_amr_refine_coarsen.jl" begin
