@testsnippet MPIP4estMesh3D begin
    EXAMPLES_DIR = joinpath(examples_dir(), "p4est_3d_dgsem")
end

@testitem "P4estMesh MPI 3D: elixir_advection_basic.jl" setup=[Setup, MPIP4estMesh3D] tags=[
    :mpi,
    :mpi_skip_windows
] begin
...
# Compressible Euler
@testitem "P4estMesh MPI 3D: elixir_euler_source_terms_nonconforming_unstructured_curved.jl" setup=[
    Setup,
    MPIP4estMesh3D
] tags=[:mpi, :mpi_skip_windows] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
...
@testitem "P4estMesh MPI 3D: elixir_euler_source_terms_nonperiodic_hohqmesh.jl" setup=[
    ...
    @trixi_testset "elixir_euler_weak_blast_wave_amr.jl (No AMR)" begin
        @test_trixi_include(joinpath(EXAMPLES_DIR,
                            ...
                            l2=[
                                0.00756870583583059,
                                0.015740513443823767,
                                0.016199289436254063,
                                0.015968915160931976,
                                0.15550037728664162
                            ],
                            linf=[
                                0.22517613430298145,
    ...
    @trixi_testset "elixir_euler_weak_blast_wave_amr.jl" begin
        @test_trixi_include(joinpath(EXAMPLES_DIR,
                            ...
                            tspan=(0.0, 0.025),
                            l2=[
                                0.013746498693950154,
                                0.019934586029924154,
                                0.020403214655756098,
                                0.020408263790073846,
                                0.149758490295039
                            ],
                            linf=[
                                0.44116017242932126,
...
@testitem "P4estMesh MPI 3D: elixir_mhd_alfven_wave_nonconforming.jl (one tree)" setup=[
    Setup,
    MPIP4estMesh3D
] tags=[:mpi, :mpi_skip_windows] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
