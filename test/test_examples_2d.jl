...
@testset "Tests for initial conditions" begin
  ...
  @testset "elixir_lbm_couette.jl with initial_condition_couette_steady" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_lbm_couette.jl"),
      l2   = [9.083820467141778e-16, 1.6316910876728276e-6, 5.024066759813544e-16,
              1.633876721130569e-6, 1.0291339569716963e-5, 8.70457731059885e-6,
              8.704679803816204e-6, 1.0291426260881264e-5, 2.6990459265690312e-15],
      linf = [1.4016565685892601e-15, 2.1580632564577318e-6, 9.853229343548264e-16,
              2.223342753376878e-6, 1.0575086819127055e-5, 9.500490606838968e-6,
              9.51531698332661e-6, 1.0607726568728076e-5, 3.4416913763379853e-15],
