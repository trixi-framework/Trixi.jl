...
@testset "Compressible Euler Multicomponent" begin
  ...
  @testset "elixir_euler_multicomponent_eoc_ec.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_multicomponent_eoc_ec.jl"),
  ...
  @testset "elixir_euler_multicomponent_eoc_es.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_multicomponent_eoc_es.jl"),
