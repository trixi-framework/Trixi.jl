...
@testset "Euler-gravity paper" begin
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_euler.toml" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_euler.toml",
  ...
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_euler.toml with N=4" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_euler.toml",
  ...
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_hyperbolic_diffusion.toml" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_hyperbolic_diffusion.toml",
  ...
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_hyperbolic_diffusion.toml with N=4" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_hyperbolic_diffusion.toml",
  ...
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml",
  ...
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml with N=4" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml",
  ...
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml with update_gravity_once_per_stage=false" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml",
  ...
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml with 1st order RK3S*" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml",
  ...
  @testset "../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml with 3rd order RK3S*" begin
    test_trixi_run("../examples/euler_gravity_paper/parameters_eoc_test_coupled_euler_gravity.toml",
