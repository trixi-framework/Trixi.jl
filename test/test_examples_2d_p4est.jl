...
@safetestset "P4estMesh" begin
  @safetestset "elixir_advection_basic_p4est.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_basic_p4est.jl"),
      l2   = [9.14468177884088e-6],
      linf = [6.437440532947036e-5])
  end

  @safetestset "elixir_advection_p4est_non_conforming_flag.jl" begin
  ...
  @safetestset "elixir_advection_p4est_non_conforming_flag_unstructured.jl" begin
  ...
  @safetestset "elixir_advection_amr_solution_independent_p4est.jl" begin
  ...
  @safetestset "elixir_advection_amr_p4est_unstructured_flag.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_amr_p4est_unstructured_flag.jl"),
      l2   = [1.29561551e-03],
      linf = [3.92061383e-02])
  end

  @safetestset "elixir_advection_restart_p4est.jl" begin
  ...
  @safetestset "elixir_euler_nonperiodic_p4est.jl" begin
  ...
  @safetestset "elixir_euler_nonperiodic_p4est_unstructured.jl" begin
  ...
  @safetestset "elixir_euler_free_stream_p4est.jl" begin
  ...
  @safetestset "elixir_eulergravity_eoc_test_p4est.jl" begin
