...
@safetestset "Compressible Euler" begin
  ...
  @safetestset "elixir_euler_source_terms.jl with split_form" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_source_terms.jl"),
  ...
  @safetestset "elixir_euler_eoc_test.jl" begin
  ...
  @safetestset "elixir_euler_mortar.jl" begin
  ...
  @safetestset "elixir_euler_amr.jl" begin
  ...
  @safetestset "elixir_euler_taylor_green_vortex.jl" begin
  ...
  @safetestset "elixir_euler_shockcapturing.jl with initial_condition_sedov_blast_wave" begin
  ...
  @safetestset "elixir_euler_shockcapturing.jl with initial_condition_sedov_self_gravity" begin
    # OBS! This setup does not run longer but crashes (also the parameters do not make sense) -> only for testing the IC!
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_shockcapturing.jl"),
  ...
  @safetestset "elixir_euler_shockcapturing_amr.jl" begin
  ...
  @safetestset "elixir_euler_density_pulse.jl" begin
  ...
  @safetestset "elixir_euler_ec.jl with initial_condition=initial_condition_constant" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_ec.jl"),
  ...
  @safetestset "elixir_euler_ec.jl with flux_chandrashekar" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_ec.jl"),
  ...
  @safetestset "elixir_euler_ec.jl with flux_kennedy_gruber" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_ec.jl"),
  ...
  @safetestset "elixir_euler_ec.jl with flux_shima_etal" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_ec.jl"),
