...
@testset "Linear scalar advection" begin
    ...
    @trixi_testset "elixir_advection_restart.jl" begin
        ...
        trixi_include(
            @__MODULE__, joinpath(EXAMPLES_DIR, "elixir_advection_extended.jl"),
        ...
        trixi_include(
            @__MODULE__, joinpath(EXAMPLES_DIR, "elixir_advection_restart.jl"),
            alg = SSPRK43()
        )
    ...
    @trixi_testset "elixir_advection_amr_visualization.jl" begin
        ...
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_amr_visualization.jl"),
    ...
    @trixi_testset "elixir_advection_timeintegration.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_timeintegration.jl"),
...
@trixi_testset "elixir_advection_callbacks.jl" begin
    @test_trixi_include(
        joinpath(EXAMPLES_DIR, "elixir_advection_callbacks.jl"),
        l2 = [8.311947673061856e-6],
        linf = [6.627000273229378e-5]
    )
    # Ensure that we do not have excessive memory allocations
