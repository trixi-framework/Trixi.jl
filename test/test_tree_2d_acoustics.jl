...
@testset "Acoustic Perturbation" begin
    ...
    @trixi_testset "elixir_acoustics_convergence.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_acoustics_convergence.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_acoustics_gauss.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_acoustics_gauss.jl"),
            l2 = [
                0.08005276517890283,
                0.08005276517890268,
                0.4187202920734123,
    ...
    @trixi_testset "elixir_acoustics_gaussian_source.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_acoustics_gaussian_source.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_acoustics_gauss_wall.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                0.019419398248465843, 0.019510701017551826,
                0.04818246051887614,
                7.382060834820337e-17, 0.0, 1.4764121669640674e-16,
                1.4764121669640674e-16,
            ],
            linf = [
                0.18193631937316496, 0.1877464607867628,
                1.0355388011792845,
    ...
    @trixi_testset "elixir_acoustics_monopole.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_acoustics_monopole.jl"),
            l2 = [
                0.006816790293009947, 0.0065068948357351625,
                0.008724512056168938,
                0.0009894398191644543, 0.0, 7.144325530679576e-17,
                7.144325530679576e-17,
            ],
            linf = [
                1.000633375007386, 0.5599788929862504, 0.5738432957070382,
