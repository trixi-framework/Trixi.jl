...
@testset "paper-self-gravitating-gas-dynamics" begin
  @testset "parameters_euler_eoc_test.toml" begin
  ...
  @testset "parameters_euler_eoc_test.toml with polydeg=4" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_eoc_test.toml"),
  ...
  @testset "parameters_hyp_diff_eoc_test.toml" begin
  ...
  @testset "parameters_hyp_diff_eoc_test.toml with polydeg=4" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_hyp_diff_eoc_test.toml"),
  ...
  @testset "parameters_euler_gravity_eoc_test.toml" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_gravity_eoc_test.toml"),
  ...
  @testset "parameters_euler_gravity_eoc_test.toml with polydeg=4" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_gravity_eoc_test.toml"),
  ...
  @testset "parameters_euler_gravity_eoc_test.toml with update_gravity_once_per_stage=false" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_gravity_eoc_test.toml"),
  ...
  @testset "parameters_euler_gravity_eoc_test.toml with 1st order RK3S*" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_gravity_eoc_test.toml"),
  ...
  @testset "parameters_euler_gravity_eoc_test.toml with 3rd order RK3S*" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_gravity_eoc_test.toml"),
  ...
  @testset "parameters_euler_gravity_sedov_blast_wave.toml" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_gravity_sedov_blast_wave.toml"),
  ...
  @testset "parameters_euler_gravity_sedov_blast_wave.toml with amr_interval=0 and ref-level=8" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_gravity_sedov_blast_wave.toml"),
