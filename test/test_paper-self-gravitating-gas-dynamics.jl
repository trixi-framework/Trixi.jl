...
@safetestset "paper-self-gravitating-gas-dynamics" begin
  ...
  @safetestset "elixir_euler_eoc_test.jl with polydeg=4" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_eoc_test.jl"),
  ...
  @safetestset "elixir_hypdiff_eoc_test.jl" begin
  ...
  @safetestset "elixir_hypdiff_eoc_test.jl with polydeg=4" begin
  @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_hypdiff_eoc_test.jl"),
  ...
  @safetestset "elixir_eulergravity_eoc_test.jl" begin
  ...
  @safetestset "elixir_eulergravity_eoc_test.jl with polydeg=4" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_eulergravity_eoc_test.jl"),
  ...
  @safetestset "elixir_eulergravity_eoc_test.jl with 1st order RK3S*" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_eulergravity_eoc_test.jl"),
  ...
  @safetestset "elixir_eulergravity_eoc_test.jl with 3rd order RK3S*" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_eulergravity_eoc_test.jl"),
  ...
  @safetestset "elixir_eulergravity_jeans_instability.jl" begin
  ...
  @safetestset "elixir_eulergravity_jeans_instability.jl with RK3S*" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_eulergravity_jeans_instability.jl"),
  ...
  @safetestset "elixir_eulergravity_sedov_blast_wave.jl" begin
  ...
  @safetestset "elixir_eulergravity_sedov_blast_wave.jl with ref-level=8 and no AMR" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_eulergravity_sedov_blast_wave.jl"),
