...
@testset "StructuredMesh2D" begin
  ...
  @trixi_testset "elixir_euler_rayleigh_taylor_instability.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_rayleigh_taylor_instability.jl"),
      l2   = [0.07623680587984416, 0.0074626608659971935, 0.003584637011910572, 0.010744382437856421],
      linf = [1.1657734098024946, 0.04325677386055257, 0.04922538705324352, 0.03815681529303916],
      tspan = (0.0, 0.3))
  end
