...
@testset "StructuredMesh2D" begin
  ...
  @trixi_testset "elixir_shallowwater_source_terms.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_shallowwater_source_terms.jl"),
      l2   = [0.0017203482162158998, 0.02559239287430658, 0.02912878158312092, 6.274146767730866e-5],
      linf = [0.013585284344354687, 0.10919050547967268, 0.16939037739868468, 0.00018196759554722775],
      tspan = (0.0, 0.05))
  end
end
