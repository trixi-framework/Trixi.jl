...
@testset "StructuredMesh2D" begin
  ...
  @trixi_testset "elixir_euler_rayleigh_taylor_instability.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_rayleigh_taylor_instability.jl"),
      l2   = [0.07623680587984825, 0.007462660865998715, 0.003584637012075067, 0.01074438243886975],
      linf = [1.1657734098021024, 0.04325677386055053, 0.049225387053377666, 0.03815681529303294],
      tspan = (0.0, 0.3))
  end
