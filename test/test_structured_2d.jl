...
@testset "StructuredMesh2D" begin
  ...
  @trixi_testset "elixir_mhd_alfven_wave.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_alfven_wave.jl"),
      l2   = [0.028897958662619586, 0.006272858922208377, 0.005649917678578073, 0.007316232594774891,
              0.004932152399591335, 0.007214814594864817, 0.007004723833708411, 0.006722186434741076,
              0.004245756514508627],
      linf = [0.1746480958095047, 0.06165987411315972, 0.03837898062190186, 0.052715221810159384,
              0.03832428091441964, 0.04261294733983656, 0.037748891483841085, 0.04802866858922464,
              0.04096314669524604],
      tspan = (0.0, 1.0))
  end
end
