...
@testset "StructuredMesh2D" begin
  ...
  @trixi_testset "elixir_shallowwater_source_terms.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_shallowwater_source_terms.jl"),
      l2   = [0.001744652445231982, 0.025150713847175182, 0.02814990567732018, 6.274146767730866e-5],
      linf = [0.011976933238024845, 0.0961436660521926, 0.154297227706234, 0.00018196759554722775],
      tspan = (0.0, 0.05))
  end
end
