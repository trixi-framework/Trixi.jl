...
@safetestset "Acoustic Perturbation" begin
  @safetestset "elixir_ape_convergence_test.jl" begin
  ...
  @safetestset "elixir_ape_gauss.jl" begin
  ...
  @safetestset "elixir_ape_gaussian_source.jl" begin
  ...
  @safetestset "elixir_ape_gauss_wall.jl" begin
  ...
  @safetestset "elixir_ape_monopole.jl" begin
