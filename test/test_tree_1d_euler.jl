...
@trixi_testset "elixir_euler_therm_perf_density_wave.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
                        ...
                        tspan=(0.0, 0.1),
                        l2=[
                            0.00010397133355045235,
                            1.4671179177582933e-5,
                            54.364721320091675
                        ],
                        linf=[
                            0.0002202565606383433,
                            4.740660817168646e-5,
                            154.54453315475257
                        ])
...
@trixi_testset "elixir_euler_therm_perf_density_wave.jl (flux_terashima_etal)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
                                 "elixir_euler_therm_perf_density_wave.jl"),
                        tspan=(0.0, 0.1),
                        l2=[
                            0.00012468286946510095,
                            2.217852396509057e-5,
                            68.65773153790823
                        ],
                        linf=[
                            0.0003422210613029941,
                            0.00010663424625556583,
                            201.25299942566198
                        ])
