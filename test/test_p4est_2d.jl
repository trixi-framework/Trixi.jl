...
@testset "P4estMesh2D" begin
    ...
    @trixi_testset "elixir_advection_basic.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_basic.jl"),
    ...
    @trixi_testset "elixir_advection_unstructured_flag.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_unstructured_flag.jl"),
    ...
    @trixi_testset "elixir_advection_restart_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_restart_amr.jl"),
    ...
    @trixi_testset "elixir_euler_free_stream.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_free_stream.jl"),
            l2 = [
            ...
            linf = [1.9539925233402755e-14, 2.0e-12, 4.8e-12, 4.0e-12],
            atol = 2.0e-12,
        )
        # Ensure that we do not have excessive memory allocations
        # (e.g., from type instabilities)
    ...
    @trixi_testset "elixir_euler_shockcapturing_ec.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_shockcapturing_ec.jl"),
            l2 = [
                9.53984675e-2,
                1.05633455e-1,
                1.05636158e-1,
    ...
    @trixi_testset "elixir_euler_sedov.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_sedov.jl"),
            l2 = [
                3.76149952e-1,
                2.46970327e-1,
                2.46970327e-1,
    ...
    @trixi_testset "elixir_euler_blast_wave_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_blast_wave_amr.jl"),
            l2 = [
                0.6321850210104147,
                0.38691446170269167,
                0.3868695626809587,
    ...
    @trixi_testset "elixir_euler_wall_bc_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_wall_bc_amr.jl"),
            l2 = [
                0.02026685991647352,
    ...
    @trixi_testset "elixir_euler_forward_step_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_forward_step_amr.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_double_mach_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_double_mach_amr.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_supersonic_cylinder.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_supersonic_cylinder.jl"),
            l2 = [
                0.02676082999794676,
                0.05110830068968181,
                0.03205164257040607,
    ...
    @trixi_testset "elixir_euler_NACA6412airfoil_mach2.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_NACA6412airfoil_mach2.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_eulergravity_convergence.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_eulergravity_convergence.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_shallowwater_source_terms.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_shallowwater_source_terms.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_mhd_alfven_wave.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_alfven_wave.jl"),
            l2 = [
                1.0513414461545583e-5, 1.0517900957166411e-6,
            ...
            linf = [
                4.255466285174592e-5, 1.0029706745823264e-5,
    ...
    @trixi_testset "elixir_mhd_rotor.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_rotor.jl"),
            l2 = [
                0.4552094211937344, 0.8918052934760807, 0.8324715234680768,
                0.0,
            ...
            linf = [
                10.19421969147307, 18.254409357804683, 10.031954811332596,
                0.0,
    ...
    @trixi_testset "elixir_euler_subsonic_cylinder.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_subsonic_cylinder.jl"),
            l2 = [
        ...
        drag = Trixi.analyze(
            drag_coefficient, du, u, tspan[2], mesh, equations, solver,
            semi.cache, semi
        )
        lift = Trixi.analyze(
            lift_coefficient, du, u, tspan[2], mesh, equations, solver,
            semi.cache, semi
        )

        @test isapprox(lift, -6.501138753497174e-15, atol = 1.0e-13)
        @test isapprox(drag, 2.588589856781827, atol = 1.0e-13)
    end
    ...
    @trixi_testset "elixir_euler_NACA0012airfoil_mach085.jl" begin
        ...
        @test isapprox(lift, 0.029094009322876882, atol = 1.0e-13)
        @test isapprox(drag, 0.13579200776643238, atol = 1.0e-13)
    end

    @trixi_testset "elixir_euler_blast_wave_pure_fv.jl" begin
        @test_trixi_include(
            joinpath(
                pkgdir(Trixi, "examples", "tree_2d_dgsem"),
    ...
    @trixi_testset "elixir_euler_weak_blast_wave_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_weak_blast_wave_amr.jl"),
            l2 = [
                0.11134260363848127,
                0.11752357091804219,
                0.11829112104640764,
        ...
        @test isapprox(state_integrals[1], initial_state_integrals[1], atol = 1.0e-13)
        @test isapprox(state_integrals[2], initial_state_integrals[2], atol = 1.0e-13)
        @test isapprox(state_integrals[3], initial_state_integrals[3], atol = 1.0e-13)
        @test isapprox(state_integrals[4], initial_state_integrals[4], atol = 1.0e-13)
    end
end
