...
@testitem "P4estMesh2D: elixir_euler_free_stream_sc_subcell.jl" setup=[Setup, P4estMesh2D] tags=[:p4est_part1] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
...
@testitem "P4estMesh2D: elixir_euler_free_stream_MCL.jl" setup=[Setup, P4estMesh2D] tags=[:p4est_part1] begin
...
@testitem "P4estMesh2D: elixir_euler_double_mach.jl" setup=[Setup, P4estMesh2D] tags=[:p4est_part1] begin
...
@testitem "P4estMesh2D: elixir_euler_supersonic_cylinder_MCL.jl" setup=[Setup, P4estMesh2D] tags=[:p4est_part1] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
