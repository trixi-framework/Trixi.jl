...
@testset "Compressible Euler" begin
    ...
    @trixi_testset "elixir_euler_source_terms.jl" begin
        ...
        exact_data = [
            initial_condition_convergence_test(
                    time_series.affect!.point_coordinates[
                        :,
                        i,
                    ],
        ...
        @test point_data ≈ exact_data atol = 1.0e-1
    ...
    @trixi_testset "elixir_euler_convergence.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_convergence.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_mortar.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_mortar.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_amr.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_amr.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_taylor_green_vortex.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_taylor_green_vortex.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_shockcapturing_amr.jl" begin
        ...
        # CI testing
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_shockcapturing_amr.jl"),
            l2 = [
                0.02217299067704248,
    ...
    @trixi_testset "elixir_euler_density_pulse.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_density_pulse.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_sedov_blast_wave.jl" begin
        @test_trixi_include(
            ...
            coverage_override = (
                maxiters = 2, initial_refinement_level = 1,
