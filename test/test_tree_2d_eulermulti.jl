...
@testset "Compressible Euler Multicomponent" begin
    @trixi_testset "Testing entropy2cons and cons2entropy" begin
        using ForwardDiff
        gammas = (
            1.1546412974182538, 1.1171560258914812, 1.097107661471476,
            1.0587601652669245, 1.6209889683979308, 1.6732209755396386,
            1.2954303574165822,
        )
        gas_constants = (
            5.969461071171914, 3.6660802003290183, 6.639008614675539,
        ...
        u = [
            -1.7433292819144075, 0.8844413258376495, 0.6050737175812364,
    ...
    @trixi_testset "elixir_eulermulti_shock_bubble.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_eulermulti_shock_bubble.jl"),
            l2 = [
                73.78467629094177,
                0.9174752929795251,
                57942.83587826468,
