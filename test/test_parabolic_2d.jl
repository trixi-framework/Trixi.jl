...
@trixi_testset "P4estMesh2D: elixir_navierstokes_viscous_shock_newton_krylov.jl" begin
    @test_trixi_include(joinpath(examples_dir(), "p4est_2d_dgsem",
                        ...
                        tspan=(0.0, 0.1),
                        l2=[
                            3.468124487467954e-5,
                            2.6454590757059137e-5,
                            2.760644360948994e-9,
                            2.8741949366621678e-5
                        ],
                        linf=[
                            0.0001876434544800798,
                            0.0001407366652957931,
                            3.8442024323011775e-8,
                            0.00014533466340793666
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    let
