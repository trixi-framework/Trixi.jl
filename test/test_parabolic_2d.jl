...
@trixi_testset "TreeMesh2D: elixir_mhd_diffusive_convergence.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "tree_2d_dgsem",
                        ...
                        initial_refinement_level=2, tspan=(0.0, 0.1),
                        l2=[
                            0.0047709920381074885,
                            0.00419249137499531,
                            0.002096054346039921,
                            0.004804941260135625,
                            0.0071708432237807375,
                            0.00415732995835522,
                            0.002050845653787598,
                            0.004804941304635838,
                            0.001010188168150027
                        ],
                        linf=[
                            0.010695184449879491,
                            0.009725291303336974,
                            0.0048621652023159425,
                            0.011292510320083823,
                            0.01602471371198444,
                            0.009614796507556644,
                            0.00473678311989012,
                            0.011292517342976843,
                            0.003062923129100001
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
