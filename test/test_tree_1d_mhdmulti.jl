...
@testset "MHD Multicomponent" begin
    ...
    @trixi_testset "elixir_mhdmulti_ec.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                0.08166807325620999, 0.054659228513541616,
            ...
            linf = [
                0.19019207422649645, 0.10059813883022888,
    ...
    @trixi_testset "elixir_mhdmulti_ec.jl with flux_derigs_etal" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhdmulti_ec.jl"),
            l2 = [
                0.08151404166186461, 0.054640238302693274,
            ...
            linf = [
                0.1824424257860952, 0.09734687137001484,
    ...
    @trixi_testset "elixir_mhdmulti_es.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                0.07994082660130175, 0.053940174914031976,
            ...
            linf = [
                0.14101014428198477, 0.07762441749521025,
    ...
    @trixi_testset "elixir_mhdmulti_convergence.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                1.7337265267786785e-5, 0.00032976971029271364,
            ...
            linf = [
                3.877554303711845e-5, 0.0012437848638874956,
    ...
    @trixi_testset "elixir_mhdmulti_briowu_shock_tube.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhdmulti_briowu_shock_tube.jl"),
            l2 = [
                0.1877830835572639, 0.3455841730726793, 0.0,
                0.35413123388836687,
            ...
            linf = [
                0.4288187627971754, 1.0386547815614993, 0.0,
                0.9541678878162702,
