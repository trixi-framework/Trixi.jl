@testsnippet MPIT8codeMesh3D begin
    EXAMPLES_DIR = joinpath(examples_dir(), "t8code_3d_dgsem")
end

@testitem "T8codeMesh MPI 3D: elixir_advection_basic.jl" setup=[Setup, MPIT8codeMesh3D] tags=[
    :mpi,
    :mpi_skip_windows
] begin
...
@testitem "T8codeMesh MPI 3D: elixir_advection_amr.jl" setup=[Setup, MPIT8codeMesh3D] tags=[
    :mpi,
    :mpi_skip_windows
] begin
...
@testitem "T8codeMesh MPI 3D: elixir_advection_amr_unstructured_curved.jl" setup=[
    Setup,
    MPIT8codeMesh3D
...
@testitem "T8codeMesh MPI 3D: elixir_advection_restart.jl" setup=[Setup, MPIT8codeMesh3D] tags=[
    :mpi,
    :mpi_skip_windows
] begin
...
# Compressible Euler
@testitem "T8codeMesh MPI 3D: elixir_euler_source_terms_nonconforming_unstructured_curved.jl" setup=[
    Setup,
    MPIT8codeMesh3D
] tags=[:mpi, :mpi_skip_windows] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
...
@testitem "T8codeMesh MPI 3D: elixir_euler_source_terms_nonperiodic.jl" setup=[
    Setup,
    MPIT8codeMesh3D
] tags=[:mpi, :mpi_skip_windows] begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
...
@testitem "T8codeMesh MPI 3D: elixir_euler_ec.jl" setup=[Setup, MPIT8codeMesh3D] tags=[
    :mpi,
    :mpi_skip_windows
] begin
