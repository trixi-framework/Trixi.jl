...
#                         l2=[
#                             0.009723896983611886,
#                             0.0013111238515950865,
#                             0.0006396321039966032,
#                             0.0014689470712485068,
#                             0.00036584841875155665,
#                             0.0013294219239204448,
#                             0.0006389687506945716,
#                             0.0014688589208027107,
#                             0.00022638806990474302
#                         ],
#                         linf=[
#                             0.014222840698982497,
#                             0.0022882258231021503,
#                             0.0011108681064092608,
#                             0.002643370501883617,
#                             0.0008390429293909651,
#                             0.00245489666601878,
#                             0.001225318177856427,
#                             0.0027498136377436325,
#                             0.0007904104649795737
#                         ])
#     let
#         t = sol.t[end]
#         u_ode = sol.u[end]
...
@trixi_testset "TreeMesh3D: elixir_mhd_diffusive_convergence.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_diffusive_convergence.jl"),
                        ...
                        l2=[
                            0.00041054724838041225, 0.0005099567160154133, 0.00026057272986618126, 0.0006104235952003212, 0.0006797465726443053, 0.0005898657308207649, 0.0001633128593686828, 0.0006138225270044615, 0.00023138655016827648
                        ],
                        linf=[
                            0.0009031508776464747, 0.002457100831981472, 0.0014555523112335924, 0.0028023093150093617, 0.0026036917025815676, 0.0027510262387238638, 0.0004574727719188765, 0.0027537130896875574, 0.0008323735886488786
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
