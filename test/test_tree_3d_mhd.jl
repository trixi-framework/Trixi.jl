...
@trixi_testset "TreeMesh3D: elixir_mhd_diffusive_convergence.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_diffusive_convergence.jl"),
                        ...
                        l2=[
                            0.00041054724838041225,
                            0.0005099567160154133,
                            0.00026057272986618126,
                            0.0006104235952003212,
                            0.0006797465726443053,
                            0.0005898657308207649,
                            0.0001633128593686828,
                            0.0006138225270044615,
                            0.00023138655016827648
                        ],
                        linf=[
                            0.0009031508776464747,
                            0.002457100831981472,
                            0.0014555523112335924,
                            0.0028023093150093617,
                            0.0026036917025815676,
                            0.0027510262387238638,
                            0.0004574727719188765,
                            0.0027537130896875574,
                            0.0008323735886488786
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
