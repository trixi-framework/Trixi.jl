...
@safetestset "Curved Mesh" begin
  ...
  @safetestset "elixir_advection_extended_curved.jl with polydeg=4" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_extended_curved.jl"),
  ...
  @safetestset "elixir_advection_rotated.jl" begin
    @safetestset "elixir_advection_rotated.jl with α = 0.0" begin
    ...
    @safetestset "elixir_advection_rotated.jl with α = 0.1" begin
      @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_rotated.jl"),
        l2   = [7.013143474176369e-6],
        linf = [4.906526503622999e-5],
        alpha = 0.1)
    ...
    @safetestset "elixir_advection_rotated.jl with α = 0.5 * pi" begin
      @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_rotated.jl"),
        l2   = [7.013143474176369e-6],
        linf = [4.906526503622999e-5],
        alpha = 0.5 * pi)
  ...
  @safetestset "elixir_advection_parallelogram.jl" begin
  ...
  @safetestset "elixir_advection_waving_flag.jl" begin
  ...
  @safetestset "elixir_advection_free_stream_curved.jl" begin
  ...
  @safetestset "elixir_advection_nonperiodic_curved.jl" begin
  ...
  @safetestset "elixir_advection_restart_curved.jl" begin
  ...
  @safetestset "elixir_advection_restart_curved.jl with waving flag mesh" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_restart_curved.jl"),
  ...
  @safetestset "elixir_advection_restart_curved.jl with free stream mesh" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_restart_curved.jl"),
  ...
  @safetestset "elixir_euler_source_terms_curved.jl" begin
  ...
  @safetestset "elixir_euler_source_terms_rotated.jl" begin
    @safetestset "elixir_euler_source_terms_rotated.jl with α = 0.0" begin
    ...
    @safetestset "elixir_euler_source_terms_rotated.jl with α = 0.1" begin
      @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_source_terms_rotated.jl"),
    ...
    @safetestset "elixir_euler_source_terms_rotated.jl with α = 0.2 * pi" begin
      @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_source_terms_rotated.jl"),
    ...
    @safetestset "elixir_euler_source_terms_rotated.jl with α = 0.5 * pi" begin
      @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_source_terms_rotated.jl"),
      l2   = [8.517808508019351e-7, 1.2350203856098537e-6, 1.2350203856728076e-6, 4.277886946638239e-6],
      linf = [8.357848139128876e-6, 1.0326302096741458e-5, 1.0326302101404394e-5, 4.496194024383726e-5],
      alpha = 0.5 * pi)
  ...
  @safetestset "elixir_euler_source_terms_parallelogram.jl" begin
  ...
  @safetestset "elixir_euler_source_terms_waving_flag.jl" begin
  ...
  @safetestset "elixir_euler_free_stream_curved.jl" begin
  ...
  @safetestset "elixir_euler_free_stream_curved.jl with FluxRotated(flux_lax_friedrichs)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_free_stream_curved.jl"),
  ...
  @safetestset "elixir_euler_nonperiodic_curved.jl" begin
  ...
  @safetestset "elixir_euler_ec_curved.jl" begin
  ...
  @safetestset "elixir_hypdiff_nonperiodic_curved.jl" begin
  ...
  @safetestset "elixir_mhd_ec_curved.jl" begin
  ...
  @safetestset "elixir_mhd_alfven_wave_curved.jl" begin
