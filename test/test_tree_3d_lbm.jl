...
@testset "Lattice-Boltzmann" begin
    ...
    @trixi_testset "elixir_lbm_constant.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                5.861930511199053e-16, 6.282772442363201e-16,
            ...
            linf = [
                1.1657341758564144e-15, 1.5543122344752192e-15,
    ...
    @trixi_testset "elixir_lbm_taylor_green_vortex.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_lbm_taylor_green_vortex.jl"),
            l2 = [
                7.516128821554829e-5, 7.516128821554695e-5,
            ...
            linf = [
                0.00021570074723312183, 0.0002157007472331357,
