...
@testset "DGMulti 3D" begin
  ...
  @trixi_testset "elixir_euler_taylor_green_vortex.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_taylor_green_vortex.jl"),
      ...
      l2 = [0.005690062908498592, 0.9795235053781499, 0.9795235053778304, 1.2791775273427266, 1.115498186009028],
      linf = [0.0007893509649481434, 0.14819539399525283, 0.14819539399590714, 0.14847291107658198, 0.21313533492059378]
    )
  end
end
