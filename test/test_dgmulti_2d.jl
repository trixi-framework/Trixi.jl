...
@testset "DGMulti 2D" begin
  ...
  @trixi_testset "elixir_mhd_weak_blast_wave.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave.jl"),
      num_cells_per_dimension = 4, tspan = (0.0, 0.1),
      l2 = [0.09654255418970953, 0.08960681445706396, 0.0896068144570643, 0.024777927633131972, 0.5123975233416294, 0.05778633331079746, 0.057786333310796675, 0.07834880208013045, 0.0014536798588212546],
      linf = [0.19806675803978135, 0.16479628118487408, 0.16479628118487644, 0.03348075888478533, 1.032342348244474, 0.08013565990036098, 0.08013565990035709, 0.1536983765913874, 0.00112393050910202]
    )
  end
end
