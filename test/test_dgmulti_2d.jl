...
@testset "DGMulti 2D" begin
  ...
  @trixi_testset "elixir_mhd_weak_blast_wave_SBP.jl (Quad)" begin
    ...
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave_SBP.jl"),
      cells_per_dimension = 4,
      l2 = [0.03950646786366336, 0.04997885031899383, 0.049313121594227176, 0.026224764914787355, 0.18340424929542234, 0.018689612293082535, 0.018709216130540402, 0.026924536116926034, 0.002112882341599928], 
      linf = [0.18340603579218184, 0.2633494608373982, 0.2655906442240918, 0.12447171382291464, 0.7787365378854822, 0.07192173365113708, 0.07004773285229504, 0.10907883650213457, 0.011611261942127716]
    )
  end
  ...
  @trixi_testset "elixir_mhd_weak_blast_wave_SBP.jl (Tri)" begin
    ...
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave_SBP.jl"),
      ...
      l2 = [0.0345694167310115, 0.038696370897154934, 0.03888146257791821, 0.013310130632668388, 0.18079127798417707, 0.019534139045118488, 0.01951466516951785, 0.02749102306384634, 0.0011990040080104855], 
      linf = [0.22767189705931457, 0.29391281632864374, 0.29182463356518595, 0.08184445627345871, 1.0975631256204177, 0.10742779995205876, 0.1056703622169225, 0.16191257015459615, 0.022351933625873798]
    )
  end
