...
@testset "DGMulti 2D" begin
  ...
  @trixi_testset "elixir_mhd_weak_blast_wave.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave.jl"),
      ...
      l2 = [0.1564315000157259, 0.19653506749633243, 0.19653506749633354, 0.10642440719248553, 0.7205928746022779, 0.07641962074102185, 0.07641962074102178, 0.11141480894811835, 0.0019910036146224054],
      linf = [0.16627777199667837, 0.245921367998527, 0.24592136799853206, 0.11921840485953497, 0.7452545174237923, 0.06211323173794714, 0.06211323173794292, 0.1055856991217714, 0.0011451320637651378]
    )
  end
end
