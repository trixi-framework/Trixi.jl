...
@testset "DGMulti 2D" begin
  ...
  @trixi_testset "elixir_mhd_weak_blast_wave_SBP.jl (Quad)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave_SBP.jl"),
      num_cells_per_dimension = 4, cfl = .25,
      l2 = [0.15837249216896104, 0.20032470727400106, 0.19729377078259655, 0.10513126816641567, 0.7315535335167392, 0.07404295970153729, 0.07405824465539662, 0.10821213261068738, 0.0052548981088832505],
      linf = [0.18413841441624967, 0.26572502960891187, 0.26804843576439896, 0.12606903463986693, 0.7836669952125446, 0.0693356520034012, 0.06837945054385619, 0.1094203095008841, 0.009034941492900034],
    )
  end
  ...
  @trixi_testset "elixir_mhd_weak_blast_wave_SBP.jl (Tri)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave_SBP.jl"),
      num_cells_per_dimension = 4, element_type=Tri(), cfl = 0.25,
      l2 = [0.15125572400823095, 0.1888669509434235, 0.17893720039336025, 0.09611217398160375, 0.7064939461307053, 0.07327899559319463, 0.0733090177978918, 0.10344091055042885, 0.004993338568014673],
      linf = [0.19906919484912255, 0.26552580395412784, 0.2664164082780063, 0.10905658253117408, 0.7724762297411862, 0.05950843420358276, 0.05897408770494095, 0.09400304529173664, 0.007141005399516567],
    )
  end
