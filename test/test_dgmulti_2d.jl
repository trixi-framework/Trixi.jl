...
@testset "DGMulti 2D" begin
  ...
  @trixi_testset "elixir_mhd_weak_blast_wave_SBP.jl (Tri)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave_SBP.jl"),
      num_cells_per_dimension = 4, element_type=Tri(),
      l2 = [0.15640401245367264, 0.19012144535398662, 0.1899522845192102, 0.1005999494561718,
            0.7333909400824864, 0.07592602959810328, 0.07590356749159335, 0.10749892474309768,
            0.005310158667887945],
      linf = [0.1909476864072146, 0.2657820404857841, 0.2658436107340353, 0.1099042358056205,
              0.731575597278538, 0.061591080699358924, 0.06150105658529337, 0.09364685593884725,
              0.006020652255682402],
    )
  end
