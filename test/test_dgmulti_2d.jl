...
@testset "DGMulti 2D" begin
  ...
  @trixi_testset "elixir_mhd_weak_blast_wave.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave.jl"),
      ...
      l2 = [0.1564827900943962, 0.1966824470701965, 0.19668244707019755, 0.10639504495017124,
            0.7205880727756032, 0.07644160038961999, 0.07644160038962199, 0.11138522669651309,
            0.0023303802856204],
      linf = [0.16567998381188986, 0.24548085844852077, 0.2454808584485253, 0.1195052326533841,
              0.7434508609863526, 0.06260342757770387, 0.06260342757770587, 0.10589713961056058,
              0.002174385718228176],
    )
  end
end
