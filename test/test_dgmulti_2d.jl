...
@trixi_testset "elixir_euler_weakform_periodic.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_weakform_periodic.jl"),
                        # division by 2.0 corresponds to normalization by the square root of the size of the domain
                        l2=[
                            0.0007492755162295128,
                            0.0007641875305302599,
                            0.0007641875305306243,
                            0.0024232389721009447
                        ],
                        linf=[
                            0.0015060064614331736,
                            0.0019371156800773726,
                            0.0019371156800769285,
                            0.004742431684202408
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
...
@trixi_testset "elixir_euler_shockcapturing_curved.jl (SBP)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_shockcapturing_curved.jl"),
                        ...
                        l2=[
                            5.187282315553801e-2,
                            3.90002358406627e-2,
                            3.7911876728729754e-2,
                            1.920415647833875e-1
                        ],
                        linf=[
                            2.751906967741987e-1,
                            2.456429848090078e-1,
                            1.7972597357839473e-1,
                            9.860080238799842e-1
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
...
@trixi_testset "elixir_euler_shockcapturing.jl (Tri, SBP)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_shockcapturing.jl"),
                        ...
                        cells_per_dimension=4, tspan=(0.0, 0.1),
                        l2=[
                            5.3090718935370146e-2,
                            4.017749660972322e-2,
                            4.204344264779104e-2,
                            1.9689984687649373e-1
                        ],
                        linf=[
                            2.504152821917871e-1,
                            2.0583365272916182e-1,
                            2.4968014441522687e-1,
                            9.036908624914783e-1
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
...
@trixi_testset "elixir_euler_gmsh_square_cylinder.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_gmsh_square_cylinder.jl"),
                        ...
                        l2=[
                            1.7050234045283715e-2,
                            2.652537417326837e-2,
                            4.85334379140645e-3,
                            8.077049959192242e-2
                        ],
                        linf=[
                            2.335248489288665,
                            2.775055393208235,
                            5.456946743294693e-1,
                            1.246993119965163e1
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
...
@trixi_testset "elixir_euler_triangulate_scramjet.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_triangulate_scramjet.jl"),
                        polydeg=1, tspan=(0.0, 0.1),
                        l2=[
                            1.5140273155138823e-1,
                            2.686529802103361e-1,
                            1.79370064864102e-1,
                            6.724881349047311e-1
                        ],
                        linf=[
                            8.912480455711576e-1,
                            1.3228111842960706,
                            1.0853357141457003,
                            3.7423065156927073
                        ])
...
@trixi_testset "elixir_euler_fdsbp_periodic.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_fdsbp_periodic.jl"),
                        l2=[
                            1.333332033888785e-6,
                            2.044834627786368e-6,
                            2.0448346278315884e-6,
                            5.282189803437435e-6
                        ],
                        linf=[
                            2.7000151703315822e-6,
                            3.988595025372632e-6,
                            3.9885950240403645e-6,
                            8.848583036513702e-6
                        ])
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
...
@trixi_testset "elixir_mhd_weak_blast_wave.jl (Quad)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave.jl"),
                        ...
                        l2=[
                            0.03906769915509508,
                            0.04923079758984701,
                            0.049230797589847136,
                            0.02660348840973283,
                            0.18054907061740028,
                            0.019195256934309846,
                            0.019195256934310016,
                            0.027856113419468087,
...
@trixi_testset "elixir_mhd_weak_blast_wave.jl (Tri)" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave.jl"),
                        ...
                        l2=[
                            ...
                            0.03971626483409167,
                            0.03971626483409208,
                            0.021427571421535722,
                            0.15079331840847413,
                            0.015716300366650286,
                            0.015716300366652128,
                            0.022365252076279075,
