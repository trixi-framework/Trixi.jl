...
@testset "DGMulti 2D" begin
    ...
    @trixi_testset "elixir_euler_weakform.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_weakform.jl"),
    ...
    @trixi_testset "elixir_euler_bilinear.jl (Bilinear quadrilateral elements, SBP, flux differencing)" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_bilinear.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_curved.jl (Quadrilateral elements, SBP, flux differencing)" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_curved.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_hohqmesh.jl (Quadrilateral elements, SBP, flux differencing)" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_hohqmesh.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_weakform.jl (convergence)" begin
        mean_convergence = convergence_test(
            @__MODULE__,
            joinpath(
                EXAMPLES_DIR,
    ...
    @trixi_testset "elixir_euler_weakform_periodic.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_weakform_periodic.jl"),
            # division by 2.0 corresponds to normalization by the square root of the size of the domain
            l2 = [
    ...
    @trixi_testset "elixir_euler_triangulate_pkg_mesh.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_triangulate_pkg_mesh.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_brown_minion_vortex.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_brown_minion_vortex.jl"),
    ...
    @trixi_testset "elixir_euler_shockcapturing.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_shockcapturing.jl"),
            cells_per_dimension = 4, tspan = (0.0, 0.1),
            l2 = [
                0.05685148333985476,
                0.04308122135907089,
    ...
    @trixi_testset "elixir_euler_shockcapturing_curved.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_shockcapturing_curved.jl"),
            cells_per_dimension = 4, tspan = (0.0, 0.1),
            l2 = [
                0.05565849298766252,
    ...
    @trixi_testset "elixir_euler_fdsbp_periodic.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_fdsbp_periodic.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_fdsbp_periodic.jl (arbitrary reference and physical domains)" begin
        global D = periodic_derivative_operator(
            derivative_order = 1,
            accuracy_order = 4,
            xmin = -200.0,
            xmax = 100.0,
    ...
    @trixi_testset "elixir_euler_fdsbp_periodic.jl (CGSEM)" begin
        D_local = SummationByPartsOperators.legendre_derivative_operator(
            xmin = 0.0,
            xmax = 1.0,
            N = 4
        )
        mesh_local = SummationByPartsOperators.UniformPeriodicMesh1D(
            xmin = -1.0,
            xmax = 1.0,
            Nx = 10
        )
    ...
    @trixi_testset "elixir_mhd_weak_blast_wave.jl (Quad)" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_weak_blast_wave.jl"),
            cells_per_dimension = 4,
            l2 = [
                0.03906769915509508, 0.04923079758984701,
            ...
            linf = [
                0.16447597822733662, 0.244157345789029,
    ...
    @trixi_testset "elixir_mhd_weak_blast_wave.jl (Tri)" begin
        @test_trixi_include(
            ...
            l2 = [
                0.03372468091254386, 0.03971626483409167,
            ...
            linf = [
                0.16290247390873458, 0.2256891306641319,
    ...
    @trixi_testset "elixir_mhd_weak_blast_wave_SBP.jl (Quad)" begin
        ...
        @test_skip @test_trixi_include(
            ...
            # division by 2.0 corresponds to normalization by the square root of the size of the domain
            l2 = [
                0.15825983698241494, 0.19897219694837923,
            ...
            linf = [
                0.1765644464978685, 0.2627803272865769,
    ...
    @trixi_testset "elixir_mhd_weak_blast_wave_SBP.jl (Tri)" begin
        ...
        @test_skip @test_trixi_include(
            ...
            # division by 2.0 corresponds to normalization by the square root of the size of the domain
            l2 = [
                0.13825044764021147, 0.15472815448314997,
            ...
            linf = [
                0.22701306227317952, 0.2905255794821543,
    ...
    @trixi_testset "elixir_mhd_reflective_wall.jl (Quad)" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_reflective_wall.jl"),
            cells_per_dimension = 4,
            l2 = [
