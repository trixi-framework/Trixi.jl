...
@testset "Examples 3D" begin
  ...
  @testset "parameters_amr_blob.toml" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_amr_blob.toml"),
            l2   = [0.046368905793586906, 0.25560087324730224, 0.03354938258651459, 0.03354938258651452, 1.054183768256977],
            linf =  [9.701700489005447, 48.42126754517581, 9.535259063203833, 9.53525906320384, 170.651558283055],
            t_end=0.2)
  end
