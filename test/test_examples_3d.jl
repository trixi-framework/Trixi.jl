...
@testset "Examples 3D" begin
  ...
  @testset "parameters_amr_euler.toml" begin
  ...
  @testset "parameters_mortar_alfven_wave.toml" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_mortar_alfven_wave.toml"),
            l2   = [0.004222069353491928, 0.008615262970183092, 0.004350750049989715, 0.010578512497282935, 0.007396881997755467, 0.008578781812069523, 0.003589437565590415, 0.010672080969050656, 0.002433803112282749],
            linf = [0.024102636344802253, 0.055214024613181104, 0.02967661132645796, 0.06663480547645528, 0.0454208040875832, 0.051820917119794974, 0.024459143124548333, 0.06552275581822167, 0.01719389063962334])
  end
  ...
  @testset "parameters_orszag_tang.toml" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_orszag_tang.toml"),
            l2   = [0.018490861368241424, 0.06801239501197921, 0.06809891993110019, 0.06814030783597733, 0.06699496859089864, 0.03513371995086266, 0.053429131923341575, 0.05348113324180276, 0.00025374872941754637],
            linf = [0.08783949409345032, 0.13993723989296752, 0.14441535080926451, 0.13939717607500923, 0.1862845099043703, 0.09834685067348178, 0.1435340208334327, 0.13481917298935625, 0.004105549371849319],
            t_end = 0.1)
