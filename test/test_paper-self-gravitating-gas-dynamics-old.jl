...
@testset "paper-self-gravitating-gas-dynamics" begin
  ...
  @testset "taal-confirmedparameters_hypdiff_eoc_test.toml" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_hypdiff_eoc_test.toml"),
  ...
  @testset "taal-confirmed parameters_hypdiff_eoc_test.toml with polydeg=4" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_hypdiff_eoc_test.toml"),
