...
@testset "Lattice-Boltzmann" begin
    ...
    @trixi_testset "elixir_lbm_constant.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_lbm_constant.jl"),
            l2 = [
                4.888991832247047e-15, 4.8856380534982224e-15,
            ...
            linf = [
                5.551115123125783e-15, 5.662137425588298e-15,
    ...
    @trixi_testset "elixir_lbm_couette.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_lbm_couette.jl"),
            l2 = [
                0.0007899749117603378, 7.0995283148275575e-6,
            ...
            linf = [
                0.005596384769998769, 4.771160474496827e-5,
    ...
    @trixi_testset "elixir_lbm_lid_driven_cavity.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_lbm_lid_driven_cavity.jl"),
            l2 = [
                0.0013628495945172754, 0.00021475256243322154,
            ...
            linf = [
                0.025886626070758242, 0.00573859077176217,
    ...
    @trixi_testset "elixir_lbm_couette.jl with initial_condition_couette_steady" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_lbm_couette.jl"),
            l2 = [
                9.321369073400123e-16, 1.6498793963435488e-6,
            ...
            linf = [
                1.4432899320127035e-15, 2.1821189867266e-6,
            ...
            initial_condition = function initial_condition_couette_steady(
                    x,
                    t,
    ...
    @trixi_testset "elixir_lbm_lid_driven_cavity.jl with stationary walls" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_lbm_lid_driven_cavity.jl"),
            l2 = [
                1.7198203373689985e-16, 1.685644347036533e-16,
            ...
            linf = [
                5.967448757360216e-16, 6.522560269672795e-16,
