...
@safetestset "Tests for initial conditions" begin
  ...
  @safetestset "elixir_advection_extended.jl with initial_condition_sin_sin" begin
  ...
  @safetestset "elixir_advection_extended.jl with initial_condition_linear_x_y" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_extended.jl"),
  ...
  @safetestset "elixir_advection_extended.jl with initial_condition_linear_y" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_advection_extended.jl"),
  ...
  # Compressible Euler
  @safetestset "elixir_euler_vortex.jl one step with initial_condition_density_pulse" begin
  ...
  @safetestset "elixir_euler_vortex.jl one step with initial_condition_pressure_pulse" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_vortex.jl"),
  ...
  @safetestset "elixir_euler_vortex.jl one step with initial_condition_density_pressure_pulse" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_vortex.jl"),
  ...
  @safetestset "elixir_euler_vortex.jl one step with initial_condition_constant" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_vortex.jl"),
  ...
  @safetestset "elixir_euler_sedov_blast_wave.jl one step" begin
  ...
  @safetestset "elixir_euler_sedov_blast_wave.jl one step with initial_condition_medium_sedov_blast_wave" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_sedov_blast_wave.jl"),
...
@safetestset "Displaying components 2D" begin
