...
@testset "Examples 3D" begin
  ...
  @testset "parameters_euler_source_terms.toml with split_form" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_source_terms.toml"),
            l2   = [0.010323099666828388, 0.00972876713766357, 0.00972876713766343, 0.009728767137663324, 0.015080409341036285],
            linf = [0.034894880154510144, 0.03383545920056008, 0.033835459200560525, 0.03383545920054587, 0.06785780622711979],
  ...
  @testset "parameters_euler_gravity_eoc_test.toml with resid_tol = 1.0e-4, t_end = 0.2" begin
  ...
  @testset "parameters_euler_mortar.toml" begin
  ...
  @testset "parameters_euler_amr.toml" begin
  ...
  @testset "parameters_euler_blob_amr.toml" begin
  ...
  @testset "parameters_euler_ec.toml with flux_kennedry_gruber" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_ec.toml"),
  ...
  @testset "parameters_euler_ec.toml with flux_shima_etal" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_euler_ec.toml"),
  ...
  @testset "parameters_euler_density_pulse.toml with source_terms_harmonic" begin
  ...
  @testset "parameters_euler_taylor_green_vortex.toml" begin
  ...
  @testset "parameters_euler_shockcapturing.toml" begin
