...
@testset "Examples 3D" begin
  ...
  @testset "taal-check-me parameters_advection_basic.toml with initial_condition_sin_periodic" begin
    test_trixi_run(joinpath(EXAMPLES_DIR, "parameters_advection_basic.toml"),
  ...
  @testset "taal-check-me parameters_euler_gravity_eoc_test.toml with resid_tol = 1.0e-4, t_end = 0.2" begin
  ...
  @testset "taal-check-me parameters_euler_blob_amr.toml" begin
