...
@trixi_testset "elixir_euler_sedov.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_sedov.jl"),
                        l2=[
                            0.054820070304023714,
                            0.025164426015869712,
                            0.027906555713413286,
                            0.025135427210715874,
                            0.35741438595043695
                        ],
                        linf=[
                            0.6311440609142686,
...
@trixi_testset "elixir_mhd_ec_shockcapturing.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_mhd_ec_shockcapturing.jl"),
                        l2=[0.010111443520791038, 0.00966307710781138,
                            0.009121879633081035, 0.009359010972850274,
                            0.03801786551896826, 0.006230513146647242,
                            0.007141816686163733, 0.005630957956561529,
                            0.0005819390669609062],
                        linf=[0.32473863297536054, 0.49912507622224245,
                            0.29187848360632573, 0.3485244134737885,
                            1.0034601240457333, 0.26659043549968464,
                            0.3061778653845586, 0.26222094690132247,
                            0.035123112983941954],
                        tspan=(0.0, 0.25),)
    # Ensure that we do not have excessive memory allocations
    # (e.g., from type instabilities)
    @test_allocations(Trixi.rhs!, semi, sol, 1000)
