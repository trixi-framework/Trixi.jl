...
@timed_testset "P4estMesh3D, FluxVolumeTurbo(flux_hindenlang_gassner, flux_nonconservative_powell)" begin
    trixi_include(@__MODULE__,
                  joinpath(EXAMPLES_DIR, "p4est_3d_dgsem",
                           "elixir_mhd_alfven_wave_nonperiodic.jl"),
                  volume_flux = Trixi.FluxVolumeTurbo(flux_hindenlang_gassner,
