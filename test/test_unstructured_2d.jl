...
@testset "UnstructuredMesh2D" begin
  ...
  @trixi_testset "elixir_euler_wall_bc.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_wall_bc.jl"),
      l2   = [0.040274258707009625, 0.04262019780467862, 0.03731994524774799, 0.1007954327797326],
      linf = [0.25626241289459717, 0.2944328751883425, 0.2884346700911081, 0.6226376249213434],
      tspan = (0.0, 0.25))
  end
