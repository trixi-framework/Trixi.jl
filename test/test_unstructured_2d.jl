...
@testset "UnstructuredMesh2D" begin
  ...
  @trixi_testset "elixir_euler_wall_bc.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR, "elixir_euler_wall_bc.jl"),
      l2   = [0.04019429774596941, 0.042563844978342216, 0.037341702572512535, 0.10058785896773718],
      linf = [0.24502990727717777, 0.298079393816715, 0.2931400178447428, 0.5936968735119608],
      tspan = (0.0, 0.25))
  end
