...
@testset "UnstructuredMesh2D" begin
    ...
    @trixi_testset "elixir_euler_periodic.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_periodic.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_wall_bc.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_wall_bc.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_restart.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_restart.jl"),
            l2 = [
                0.0007213418215265047,
                0.0006752337675043779,
                0.0006437485997536973,
    ...
    @trixi_testset "elixir_euler_time_series.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_time_series.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_acoustics_gauss_wall.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_acoustics_gauss_wall.jl"),
            l2 = [
                0.029330394861252995, 0.029345079728907965,
                0.03803795043486467, 0.0,
                7.175152371650832e-16, 1.4350304743301665e-15,
                1.4350304743301665e-15,
            ],
            linf = [
                0.36236334472179443, 0.3690785638275256,
    ...
    @trixi_testset "elixir_mhd_ec.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                0.06418293357851637, 0.12085176618704108,
            ...
            linf = [
                0.1417000509328017, 0.3210578460652491, 0.335041095545175,
                0.22500796423572675,
    ...
    @trixi_testset "elixir_mhd_alfven_wave.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                5.377518922553881e-5, 0.09999999206243514,
            ...
            linf = [
                0.00039334982566352483, 0.14144904937275282,
    ...
    @trixi_testset "elixir_shallowwater_ec.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_shallowwater_ec.jl"),
            l2 = [
                0.6107326269462766,
                0.48666631722018877,
                0.48309775159067053,
    ...
    @trixi_testset "elixir_shallowwater_ec_float32.jl" begin
        ...
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_shallowwater_ec_float32.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_shallowwater_dirichlet.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_shallowwater_dirichlet.jl"),
            l2 = [
    ...
    @trixi_testset "FDSBP (central): elixir_advection_basic.jl" begin
        @test_trixi_include(
            joinpath(
                pkgdir(Trixi, "examples", "unstructured_2d_fdsbp"),
    ...
    @trixi_testset "FDSBP (upwind): elixir_euler_source_terms_upwind.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                4.085391175504837e-5,
                7.19179253772227e-5,
                7.191792537723135e-5,
                0.0002177522206115571,
            ],
            linf = [
                0.0004054489124620808,
