...
@testset "Linear scalar advection" begin
    ...
    @trixi_testset "elixir_advection_upwind.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_upwind.jl"),
    ...
    @trixi_testset "elixir_advection_upwind_periodic.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_upwind_periodic.jl"),
...
@testset "Inviscid Burgers" begin
    @trixi_testset "elixir_burgers_basic.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_burgers_basic.jl"),
    ...
    @trixi_testset "elixir_burgers_linear_stability.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_burgers_linear_stability.jl"),
...
@testset "Compressible Euler" begin
    ...
    @trixi_testset "elixir_euler_convergence.jl with VolumeIntegralStrongForm" begin
        @test_trixi_include(
            ...
            tspan = (0.0, 0.5),
            solver = DG(
                D_upw.central, nothing, SurfaceIntegralStrongForm(),
