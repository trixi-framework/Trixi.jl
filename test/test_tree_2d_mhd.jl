...
@testset "MHD" begin
    ...
    @trixi_testset "elixir_mhd_alfven_wave_mortar.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_alfven_wave_mortar.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_mhd_orszag_tang.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_orszag_tang.jl"),
            l2 = [
                0.21967600768935716,
                0.2643126515795721,
                0.31488287201980875,
    ...
    @trixi_testset "elixir_mhd_blast_wave.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_blast_wave.jl"),
            l2 = [
                0.17646728395490927,
                3.866230215339417,
                2.4867304651291255,
    ...
    @trixi_testset "elixir_mhd_shockcapturing_subcell.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_shockcapturing_subcell.jl"),
            l2 = [
                3.2064026219236076e-2,
                7.2461094392606618e-2,
                7.2380202888062711e-2,
                0.0e+0,
                8.6293936673145932e-1,
                8.4091669534557805e-3,
                5.2156364913231732e-3,
                0.0e+0,
                2.0786952301129021e-4,
            ],
            linf = [
                3.8778760255775635e-1,
                9.4666683953698927e-1,
                9.4618924645661928e-1,
                0.0e+0,
                1.0980297261521951e+1,
                1.0264404591009069e-1,
                1.065568694217635e-1,
                0.0e+0,
                6.1013422157115546e-3,
            ],
            tspan = (0.0, 0.003)
        )
        # Ensure that we do not have excessive memory allocations
