...
# Set defaults
if (!exists("infile")) infile="gassner_001240.txt" 
if (!exists("infile2")) infile2="NN_001525.txt"
#if (!exists("infile3")) infile3="NN_.txt"

if (!exists("eqn")) eqn="euler"    #"linear_scalar_advection"
ext = ".pdf"
...
if (eqn eq "euler") {
  set title "rho"
  set key outside
  plot infile u 1:2 w l lw 3 title "Gassner"  , \
       infile2 u 1:2 w l lw 3 title "NN"
       #infile3 u 1:2 w l lw 3 title "NN2"
...
if (eqn eq "euler") {
  set title "v1"
  set key outside
  plot infile u 1:3 w l lw 3 title "Gassner", \
       infile2 u 1:3 w l lw 3 title "NN"
       #infile3 u 1:3 w l lw 3 title "NN2"
}
set out "p_end".ext
if (eqn eq "euler") {
  set title "p"
  set key outside
  plot infile u 1:4 w l lw 3 title "Gassner", \
       infile2 u 1:4 w l lw 3 title "NN"
       #infile3 u 1:4 w l lw 3 title "NN2"
