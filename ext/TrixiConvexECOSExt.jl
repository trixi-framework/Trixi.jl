...
@muladd begin
    ...
    function stability_polynomials!(
            pnoms, consistency_order, num_stage_evals,
...
=#
    ...
    function Trixi.bisect_stability_polynomial(
            consistency_order, num_eig_vals,
            num_stage_evals,
        ...
        while dtmax - dtmin > dteps
            ...
            problem = minimize(
                stability_polynomials!(
                    pnoms, consistency_order,
                    num_stage_evals,
                    normalized_powered_eigvals_scaled,
                    gamma
                )
