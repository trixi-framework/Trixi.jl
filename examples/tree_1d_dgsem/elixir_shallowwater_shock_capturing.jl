...
function initial_condition_stone_throw_discontinuous_bottom(x, t, element_id,
...
for element in eachelement(semi.solver, semi.cache)
  for i in eachnode(semi.solver)
    ...
    u_node = initial_condition_stone_throw_discontinuous_bottom(x_node, first(tspan),
                                                                element, equations)
