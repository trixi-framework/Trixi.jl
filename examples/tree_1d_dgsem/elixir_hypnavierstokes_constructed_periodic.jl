...
coordinates_max = 2*pi # maximum coordinate

# Create a uniformely refined mesh with periodic boundaries
mesh = TreeMesh(coordinates_min, coordinates_max,
                initial_refinement_level=4,
                n_cells_max=30_000,
                periodicity=true) # set maximum capacity of tree data structure


initial_condition = initial_condition_constructed_periodic

semi = SemidiscretizationHyperbolic(mesh, equations, initial_condition, solver,
                                    source_terms=source_terms_constructed_periodic)
