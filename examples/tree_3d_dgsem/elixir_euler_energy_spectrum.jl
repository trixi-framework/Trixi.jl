...
save_plot = false
plot_filename = joinpath("out", "energy_spectrum_3d_dgsem.png")
nvisnodes = 4
...
The classical inviscid Taylor-Green vortex. This setup is used here only as a simple periodic
...
mean_kinetic_energy = sum(@. 0.5 * rho_cartesian *
                             (v1_cartesian^2 + v2_cartesian^2 + v3_cartesian^2)) /
