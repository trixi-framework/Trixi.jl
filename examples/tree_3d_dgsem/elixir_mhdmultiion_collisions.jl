...
function initial_condition_slow_down(x, t, equations::IdealGlmMhdMultiIonEquations3D)
    RealT = eltype(x)
...
function temperature1(u, equations::IdealGlmMhdMultiIonEquations3D)
...
function temperature2(u, equations::IdealGlmMhdMultiIonEquations3D)
...
function source_terms(u, x, t, equations::IdealGlmMhdMultiIonEquations3D)
