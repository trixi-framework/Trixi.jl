...
## Mesh with prisms/wedges.
## But it is unstable. Crashes with domain error.
## tensor_polydeg = (1,1)
## element_type = Wedge()
## 
...
# ndays = 10
ndays = 100
tspan = (0.0, ndays * 24 * 60 * 60.0) # time in seconds for 10 days
...
sol = solve(ode, RDPK3SpFSAL49(thread = Trixi.True()); abstol = 1.0e-6,
            reltol = 1.0e-6,
