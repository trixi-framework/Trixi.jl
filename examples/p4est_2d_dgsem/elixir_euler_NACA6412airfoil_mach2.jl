...
@inline function boundary_condition_supersonic_outflow(
        u_inner,
...
isfile(mesh_file) ||
    Trixi.download(
    "https://gist.githubusercontent.com/DanielDoehring/e2a389f04f1e37b33819b9637e8ee4c3/raw/4bf7607a2ce4432fdb5cb87d5e264949b11bd5d7/mesh_NACA6412.inp",
    mesh_file
)
...
boundary_conditions = Dict(
    :PhysicalLine1 => boundary_condition_supersonic_inflow, # Left boundary
...
###############################################################################
sol = solve(
    ode, SSPRK104(; thread = OrdinaryDiffEq.True());
