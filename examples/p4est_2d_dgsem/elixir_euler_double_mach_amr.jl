...
"""
@inline function initial_condition_double_mach_reflection(
        x, t,
...
@inline function boundary_condition_mixed_dirichlet_wall(
    ...
    if x[1] < 1 / 6
        ...
        flux = boundary_condition_slip_wall(
...
mesh_file = Trixi.download(
    "https://gist.githubusercontent.com/andrewwinters5000/a0806ef0d03cf5ea221af523167b6e32/raw/61ed0eb017eb432d996ed119a52fb041fe363e8c/abaqus_double_mach.inp",
