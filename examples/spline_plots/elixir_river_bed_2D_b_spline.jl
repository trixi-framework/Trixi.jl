...
spline_data = download("https://gist.githubusercontent.com/maxbertrand1996/7b1b943eac142d5bc836bb818fe83a5a/raw/67500b54a81c671c3f6834002defedb87ebe8a45/Rhine_data_2D_10.txt")

# Fill structure
b_spline_free      = bicubic_b_spline(spline_data; boundary = "free")
b_spline_free_smth = bicubic_b_spline(spline_data; boundary = "free", smoothing_factor = λ)
b_spline_knot      = bicubic_b_spline(spline_data; boundary = "not-a-knot")
b_spline_knot_smth = bicubic_b_spline(spline_data; boundary = "not-a-knot", smoothing_factor = λ)
...
p_free_smth = plot(x_int, y_int, z_free_smth, st =:surface, 
                   title = "Free boundary, smooth (λ = $λ)")
p_knot      = plot(x_int, y_int, z_knot, st =:surface, title = "Not-a-knot boundary")
p_knot_smth = plot(x_int, y_int, z_knot_smth, st =:surface, 
                   title = "Not-a-knot boundary, smooth (λ = $λ)")
