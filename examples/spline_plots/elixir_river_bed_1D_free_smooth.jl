...
spline        = cubic_spline(joinpath("examples","spline_plots","Rhine_data_1D_100.txt"))
spline_smooth = cubic_spline(joinpath("examples","spline_plots","Rhine_data_1D_100.txt"); smoothing_factor = λ)
