...
# solver = DGSEM(polydeg = 3, surface_flux = FluxLaxFriedrichs(max_abs_speed),
...
function initial_condition_blast_wave(x, t, equations::CompressibleEulerEquations2D)
    ...
    p = r > 0.5f0 ? RealT(1.0E-2) : RealT(1.245)
...
time_int_tol = 1e-4
sol = solve(ode, SSPRK43(); abstol = 1e-2 * time_int_tol, reltol = time_int_tol, dt = 1e-6,
