...
# Tolerate entropy decrease per stage to 1.8 times the reference entropy.
# Note: This is a relatively anti-diffusive setup.
stage_callbacks = (EntropyBoundedLimiter(exp_entropy_decrease_max = -exp_s_min * 1.8),)
