...
entropy_corr_cb = Trixi.EntropyIndicatorUpdateStepCB(indicator = indicator)
...
#=
stage_callbacks = (Trixi.EntropyIndicatorUpdateStageCB(indicator = indicator),)
ode_alg = Trixi.SimpleSSPRK33(stage_callbacks = stage_callbacks)
ode_alg  = Trixi.SimpleSSPRK33()
