...
@inline function Trixi.max_abs_speeds(u, equation::KPPEquation2D)
    (wavespeed(equation), wavespeed(equation))
end
@inline function Trixi.max_abs_speed_naive(u_ll,
    u_rr,
    orientation::Integer,
...
@inline function Trixi.max_abs_speed_naive(u_ll,
    ...
    equation::KPPEquation2D)
    wavespeed(equation) * norm(normal_direction)
end
