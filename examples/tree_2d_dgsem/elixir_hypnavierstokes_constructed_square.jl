...
solver = DGSEM(2, flux_lax_friedrichs)

coordinates_min = (1, 1) # minimum coordinate
coordinates_max = (2, 2) # maximum coordinate
...
initial_condition = initial_condition_constructed_square

boundary_conditions = BoundaryConditionDirichlet(initial_condition)

semi = SemidiscretizationHyperbolic(mesh, equations, initial_condition, solver,
                                    boundary_conditions=boundary_conditions,
                                    source_terms=source_terms_constructed_square)
