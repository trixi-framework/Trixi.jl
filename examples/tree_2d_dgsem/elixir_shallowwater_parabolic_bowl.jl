...
by an oscillating lake. Due to the limit of useable cells within `TreeMesh``, the simulation cannot be
too accurate. For a nicer result, see the elixir using `StructuredMesh`.
