...
# This elixir calculates the sound generated by a pair of co-rotating vortices in a queiscent
# medium.
...
source_region(x) = sum(x.^2) < 6.0^2 # calculate sources within radius 6 around origin
