...
function (initial_condition::InitialCondition)(x,
    t,
...
sponge_layer_euler = VortexPairSetup.SpongeLayer(sponge_layer_min = (-135 * r0,
        115 * r0,
        -135 * r0,
        115 * r0),
...
euler_acoustics_coupling = EulerAcousticsCouplingCallback(ode_euler, "out/averaging.h5",
    ...
    callback = SaveRestartCallback(interval = 2300, output_directory = "out/euler/"))
