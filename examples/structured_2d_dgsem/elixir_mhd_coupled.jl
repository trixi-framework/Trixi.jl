...
function flux_nonconservative_powell(
        u_ll, u_rr,
        normal_direction_ll::AbstractVector,
        equations::IdealGlmMhdEquations2D
    )
    flux_nonconservative_powell(
        u_ll, u_rr, normal_direction_ll, normal_direction_ll,
        equations
    )
end
...
semi1 = SemidiscretizationHyperbolic(
    mesh1, equations, initial_condition1, solver,
...
semi2 = SemidiscretizationHyperbolic(
    mesh2, equations, initial_condition2, solver,
...
glm_speed_callback = GlmSpeedCallback(
    glm_scale = 0.5, cfl = cfl,
    semi_indices = [1, 2]
)
