...
module TrixiExtensionEulerRotated
    ...
    function (initial_condition::InitialConditionSourceTermsRotated)(
            x, t,
        ...
        rho, rho_v1, rho_v2, rho_e = initial_condition_convergence_test(
            SVector(x1, x2), t,
            equations
        )
    ...
    @inline function (source_terms::InitialConditionSourceTermsRotated)(
            u, x, t,
            equations::CompressibleEulerEquations2D
        )
...
semi = SemidiscretizationHyperbolic(
    mesh, equations, initial_condition_source_terms, solver,
