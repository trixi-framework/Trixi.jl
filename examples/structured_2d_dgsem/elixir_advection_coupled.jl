...
mesh1 = StructuredMesh(
    cells_per_dimension, coordinates_min1, coordinates_max1,
    periodicity = false
)
...
boundary_conditions_x_neg1 = BoundaryConditionCoupled(
    2, (:end, :i_forward), Float64,
    coupling_function12
)
boundary_conditions_x_pos1 = BoundaryConditionCoupled(
    2, (:begin, :i_forward), Float64,
    coupling_function12
)
boundary_conditions_y_neg1 = BoundaryConditionCoupled(
    3, (:i_forward, :end), Float64,
    coupling_function13
)
boundary_conditions_y_pos1 = BoundaryConditionCoupled(
    3, (:i_forward, :begin), Float64,
    coupling_function13
)
...
mesh2 = StructuredMesh(
    cells_per_dimension, coordinates_min2, coordinates_max2,
    periodicity = false
)
...
# Define the coupling boundary conditions and the system it is coupled to.
boundary_conditions_x_neg2 = BoundaryConditionCoupled(
    1, (:end, :i_forward), Float64,
    coupling_function21
)
boundary_conditions_x_pos2 = BoundaryConditionCoupled(
    1, (:begin, :i_forward), Float64,
    coupling_function21
)
boundary_conditions_y_neg2 = BoundaryConditionCoupled(
    4, (:i_forward, :end), Float64,
    coupling_function24
)
boundary_conditions_y_pos2 = BoundaryConditionCoupled(
    4, (:i_forward, :begin), Float64,
    coupling_function24
)
...
mesh3 = StructuredMesh(
    cells_per_dimension, coordinates_min3, coordinates_max3,
    periodicity = false
)
...
# Define the coupling boundary conditions and the system it is coupled to.
boundary_conditions_x_neg3 = BoundaryConditionCoupled(
    4, (:end, :i_forward), Float64,
    coupling_function34
)
boundary_conditions_x_pos3 = BoundaryConditionCoupled(
    4, (:begin, :i_forward), Float64,
    coupling_function34
)
boundary_conditions_y_neg3 = BoundaryConditionCoupled(
    1, (:i_forward, :end), Float64,
    coupling_function31
)
boundary_conditions_y_pos3 = BoundaryConditionCoupled(
    1, (:i_forward, :begin), Float64,
    coupling_function31
)

# A semidiscretization collects data structures and functions for the spatial discretization
semi3 = SemidiscretizationHyperbolic(
    mesh3, equations, initial_condition_convergence_test,
    solver,
    boundary_conditions = (
...
mesh4 = StructuredMesh(
    cells_per_dimension, coordinates_min4, coordinates_max4,
    periodicity = false
)
...
# Define the coupling boundary conditions and the system it is coupled to.
boundary_conditions_x_neg4 = BoundaryConditionCoupled(
    3, (:end, :i_forward), Float64,
    coupling_function43
)
boundary_conditions_x_pos4 = BoundaryConditionCoupled(
    3, (:begin, :i_forward), Float64,
    coupling_function43
)
boundary_conditions_y_neg4 = BoundaryConditionCoupled(
    2, (:i_forward, :end), Float64,
    coupling_function42
)
boundary_conditions_y_pos4 = BoundaryConditionCoupled(
    2, (:i_forward, :begin), Float64,
    coupling_function42
)

# A semidiscretization collects data structures and functions for the spatial discretization
semi4 = SemidiscretizationHyperbolic(
    mesh4, equations, initial_condition_convergence_test,
    solver,
    boundary_conditions = (
...
analysis_callback = AnalysisCallbackCoupled(
    semi, analysis_callback1, analysis_callback2,
