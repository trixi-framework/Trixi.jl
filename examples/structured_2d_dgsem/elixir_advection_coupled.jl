...
semi1 = SemidiscretizationHyperbolic(mesh1, equations, initial_condition_convergence_test, solver; boundary_conditions = (;
...
# A semidiscretization collects data structures and functions for the spatial discretization
semi2 = SemidiscretizationHyperbolic(mesh2, equations, initial_condition_convergence_test, solver; boundary_conditions = (;
...
# A semidiscretization collects data structures and functions for the spatial discretization
semi3 = SemidiscretizationHyperbolic(mesh3, equations, initial_condition_convergence_test, solver; boundary_conditions = (;
...
# A semidiscretization collects data structures and functions for the spatial discretization
semi4 = SemidiscretizationHyperbolic(mesh4, equations, initial_condition_convergence_test, solver; boundary_conditions = (;
