...
- The internal ODE right-hand side functions such as `rhs!` now dispatch additionally on the backend type ([#3113]). The public interface `rhs!(du_ode, u_ode, semi, t)` is unchanged.
