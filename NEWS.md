...
- Added experimental second-order reconstructions for 1D `TreeMesh` `BlockFV` via `BlockFVO2` and `VolumeIntegralFiniteVolumeO2`, with volume-local higher-order reconstruction and reconstructed states at element interfaces and boundaries ([#3156]).
