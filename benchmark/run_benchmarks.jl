...
let results = judge(Trixi,
    ...
    export_markdown(joinpath(pathof(Trixi) |> dirname |> dirname, "benchmark", "results_threads1.md"), results)
end
...
let results = judge(Trixi,
    ...
    export_markdown(joinpath(pathof(Trixi) |> dirname |> dirname, "benchmark", "results_threads2.md"), results)
end
