...
let results = judge(Trixi,
                    ...
                    BenchmarkConfig(juliacmd = `$(Base.julia_cmd()) --threads=1`,
                                    id = "main"))
...
let results = judge(Trixi,
                    BenchmarkConfig(juliacmd = `$(Base.julia_cmd()) --threads=2`), # target
                    BenchmarkConfig(juliacmd = `$(Base.julia_cmd()) --threads=2`,
                                    id = "main"))
