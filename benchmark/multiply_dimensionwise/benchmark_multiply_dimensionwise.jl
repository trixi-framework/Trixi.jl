...
@generated function multiply_dimensionwise_sequential_nexpr!(
        data_out::AbstractArray{<:Any, 3}, data_in::AbstractArray{<:Any, 3}, vandermonde::SMatrix{n_nodes_out, n_nodes_in}, ::Val{n_vars}
    ) where {n_nodes_out, n_nodes_in, n_vars}
    quote
        @boundscheck begin
...
@generated function multiply_dimensionwise_sequential_nexpr!(
        data_out::AbstractArray{<:Any, 4}, data_in::AbstractArray{<:Any, 4}, vandermonde::SMatrix{n_nodes_out, n_nodes_in}, ::Val{n_vars}
    ) where {n_nodes_out, n_nodes_in, n_vars}
    quote
        @boundscheck begin
            inbounds = (size(data_out, 1) == $n_vars) &&
