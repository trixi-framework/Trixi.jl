...
plot!([0.5, 2.5], [-2.75, -2.75], linecolor = "green", label = false, linewidth = 15, opacity = 0.3)
...
plot!([0.25, 1.25], [2.5, 2.5], linecolor = "green", label = false, linewidth = 15, opacity = 0.3)

# 3
plot!(Shape([(0, 0), (0, 1), (1, 1), (1, 0)] .+ [(0.25, 0.0), (0.25, 0.0), (0.25, 0.0), (0.25, 0.0)]), linecolor = "black", fillcolor = "white", label = false, linewidth = 2)

nodes_2d = nodes_project_four([(0, 0), (0, 1), (1, 1), (1, 0)] .+ [(0.25, 0.0), (0.25, 0.0), (0.25, 0.0), (0.25, 0.0)])
scatter!(nodes_2d[:, 1], nodes_2d[:, 2], color = "red", label = false, markersize = 5)

plot!([1.25, 1.75], [0.5, 0.5], linecolor = "blue", fillcolor = "white", label = false, linewidth = 3)
plot!([-0.25, 0.25], [0.5, 0.5], linecolor = "blue", fillcolor = "white", label = false, linewidth = 3)

# 4
plot!(Shape([(2, 0), (2, 1), (1, 1), (1, 0)] .+ [(0.75, 0.0), (0.75, 0.0), (0.75, 0.0), (0.75, 0.0)]), linecolor = "black", fillcolor = "white", label = false, linewidth = 2)

nodes_2d = nodes_project_four([(2, 0), (2, 1), (1, 1), (1, 0)] .+ [(0.75, 0.0), (0.75, 0.0), (0.75, 0.0), (0.75, 0.0)])
scatter!(nodes_2d[:, 1], nodes_2d[:, 2], color = "red", label = false, markersize = 5)
...
plot!([-1.75, -1.25], [0.5, 0.5], linecolor = "blue", fillcolor = "white", label = false, linewidth = 3)
...
# 4
plot!(Shape([(-0, 0), (-1, 0), (-1, 1), (-0, 1)] .+ [(-0.25, 0.0), (-0.25, 0.0), (-0.25, 0.0), (-0.25, 0.0)]), linecolor = "black", fillcolor = "white", label = false, linewidth = 2)

nodes_2d = nodes_project_four([(-0, 0), (-1, 0), (-1, 1), (-0, 1)] .+ [(-0.25, 0.0), (-0.25, 0.0), (-0.25, 0.0), (-0.25, 0.0)])
scatter!(nodes_2d[:, 1], nodes_2d[:, 2], color = "red", label = false, markersize = 5)
...
nodes_2d = nodes_project_four([(-2.0, -2.0), (-2.0, -1.0), (-1.0, -1.0), (-1.0, -2.0)] .+ [(-0.75, -1), (-0.75, -1), (-0.75, -1), (-0.75, -1)])
scatter!(nodes_2d[:, 1], nodes_2d[:, 2], color = "red", label = false, markersize = 5)
...
nodes_2d = nodes_project_four([(-1.0, -2.0), (-1.0, -1.0), (-0.0, -1.0), (-0.0, -2.0)] .+ [(-0.25, -1), (-0.25, -1), (-0.25, -1), (-0.25, -1)])
scatter!(nodes_2d[:, 1], nodes_2d[:, 2], color = "red", label = false, markersize = 5)
