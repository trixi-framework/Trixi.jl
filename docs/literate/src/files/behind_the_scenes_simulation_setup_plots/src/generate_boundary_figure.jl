...
plot!([2.5, 2.5], [-0.75, -2.75], linecolor = "green", label = "boundaries with nodes",
      linewidth = 15, opacity = 0.3)
plot!([0.5, 2.5], [-2.75, -2.75], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([2.75, 2.75], [2.5, 1.5], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
plot!([1.75, 2.75], [2.5, 2.5], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([0.25, 1.25], [2.5, 2.5], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([2.75, 2.75], [1, 0], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([-1.25, -0.25], [2.5, 2.5], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([-1.75, -2.75], [2.5, 2.5], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
plot!([-2.75, -2.75], [1.5, 2.5], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([-2.75, -2.75], [0, 1], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([-2.75, -2.75], [-0.5, -1.5], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([-2.75, -2.75], [-2, -3], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
plot!([-2.75, -1.75], [-3, -3], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
...
plot!([-0.25, -1.25], [-3, -3], linecolor = "green", label = false, linewidth = 15,
      opacity = 0.3)
