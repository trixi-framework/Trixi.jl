...
# ### [Number: First steps in Trixi.jl](@ref getting_started)
#-
...
# ### [Number: Behind the scenes of a simulation setup](@ref behind_the_scenes_simulation_setup)
#-
...
# ### [Number: Introduction to DG methods](@ref scalar_linear_advection_1d)
#-
...
# ### [Number: DGSEM with flux differencing](@ref DGSEM_FluxDiff)
#-
...
# ### [Number: Shock capturing with flux differencing and stage limiter](@ref shock_capturing)
#-
...
# ### [Number: Non-periodic boundary conditions](@ref non_periodic_boundaries)
#-
...
# ### [Number: DG schemes via `DGMulti` solver](@ref DGMulti_1)
#-
...
# ### [Number: Other SBP schemes (FD, CGSEM) via `DGMulti` solver](@ref DGMulti_2)
#-
...
# ### [Number: Upwind FD SBP schemes](@ref upwind_fdsbp)
#-
...
# ### [Number: Adding a new scalar conservation law](@ref adding_new_scalar_equations)
#-
...
# ### [Number: Adding a non-conservative equation](@ref adding_nonconservative_equation)
#-
...
# ### [Number: Structured mesh with curvilinear mapping](@ref structured_mesh_mapping)
#-
...
# ### [Number: Unstructured meshes with HOHQMesh.jl](@ref hohqmesh_tutorial)
#-
...
# ### [Number: P4est mesh from gmsh](@ref p4est_from_gmsh)
#-
...
# ### [Number: Explicit time stepping](@ref time_stepping)
#-
...
# ### [Number: Differentiable programming](@ref differentiable_programming)
#-
...
# ### [Number: Custom semidiscretization](@ref custom_semidiscretization)
#-
