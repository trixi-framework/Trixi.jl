...
Trixi.jl output file(s) using the [`Trixi2Vtk`](https://github.com/trixi-framework/Trixi2Vtk.jl) tool
...
We can then visualize the solution at the final time on the new mesh.
