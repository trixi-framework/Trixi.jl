...
Literate.notebook(joinpath(@__DIR__,"first_example.jl"), joinpath(@__DIR__,"notebooks"); preprocess=preprocess_notebook)
Literate.markdown(joinpath(@__DIR__,"first_example.jl"), joinpath(@__DIR__,"markdowns"); preprocess=preprocess_docs, codefence="```julia" => "```")
