...
- `flux_differencing_kernel_type`: Select the GPU kernel used for the flux differencing
...
function semidiscretize(semi::AbstractSemidiscretization, tspan;
                        ...
                        storage_type = nothing,
                        real_type = nothing,
                        flux_differencing_kernel_type = nothing)
    ...
    if storage_type !== nothing || flux_differencing_kernel_type !== nothing
        ...
        @reset semi.cache = (; semi.cache..., flux_differencing_kernel_type)
    end
