...
@muladd begin
    ...
    struct SemidiscretizationHyperbolicParabolic{
            Mesh, Equations, EquationsParabolic,
            InitialCondition,
            BoundaryConditions,
    ...
    function SemidiscretizationHyperbolicParabolic(
        ...
        _boundary_conditions_parabolic = digest_boundary_conditions(
    ...
    function semidiscretize(
            semi::SemidiscretizationHyperbolicParabolic, tspan;
            reset_threads = true
        )
    ...
    function _jacobian_ad_forward(
            semi::SemidiscretizationHyperbolicParabolic, t0, u0_ode,
            du_ode, config
        )
