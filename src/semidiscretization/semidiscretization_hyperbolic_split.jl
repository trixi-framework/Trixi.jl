...
initial_cache2...)
_boundary_conditions1 = digest_boundary_conditions(boundary_conditions1, mesh, solver1,
             cache1)
...
boundary_conditions1, source_terms, solver1, cache1)
...
function rhs2!(du_ode, u_ode, semi::SemidiscretizationHyperbolicSplit, t)
    ...
    boundary_conditions2, source_terms, solver2, cache2)
    runtime = time_ns() - time_start
