...
function Base.show(io::IO, @nospecialize semi::SemidiscretizationHyperbolic)
...
function Base.show(io::IO, ::MIME"text/plain", @nospecialize semi::SemidiscretizationHyperbolic)
