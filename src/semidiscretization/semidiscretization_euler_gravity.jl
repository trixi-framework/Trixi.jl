...
function timestep_gravity_erk_test_3Sstar!(cache, u_euler, t, dt, gravity_parameters, semi_gravity)
  ...
  # # even if it is restricted to smaller CFL numbers.
  # # For coupled EOC and Jeans, it's not better than the method above. However, it seems
  # # to be significantly better for Sedov, although not as good as the ERK52...
  ...
  # # 4 stages, order 1, 3Sstar-1-4_2021-02-10T15-42-35.txt
  # # This scheme is created via a matrix Chebyshev polynomial for
  # # initial_condition_harmonic_nonperiodic, solver = DGSEM(3, flux_godunov), initial_refinement_level=1
  # # For simple hyp. diff. tests in bounded domains, it appears to be a bit better than the correspondiing three-stage method
  # # For coupled problems, it's not better...
  # gamma1 = SVector(0.0000000000000000E+00, 5.0509487123519858E-01, 6.5590309895519616E-01, -7.4384070710120431E-02)
  # gamma2 = SVector(1.0000000000000000E+00, 4.1270258419041189E-01, 1.8357032327886819E-01, 5.8611148576575367E-01)
  # gamma3 = SVector(0.0000000000000000E+00, 0.0000000000000000E+00, 0.0000000000000000E+00, -2.4263806116808284E-02)
  # beta   = SVector(4.1879145671649565E-01, 2.9808324215529908E-01, 2.5468200683428666E-01, 7.8742489426129236E-01)
  # delta  = SVector(1.0000000000000000E+00, 1.9918107548476838E-01, 6.7528803748875943E-01, 0.0000000000000000E+00)
  # c      = zero(gamma1)
  ...
  # # 5 stages, order 1, 3Sstar-1-5_2021-02-10T15-48-13.txt
  # gamma1 = SVector(0.0000000000000000E+00, 7.2254998017220551E-01, 1.0756353137475603E+00, 7.6829755182286963E-02, -1.5318028931773793E+00)
  # gamma2 = SVector(1.0000000000000000E+00, 2.6742978841538312E-01, -7.7855471302170631E-02, 4.2819764434656510E-01, 1.1269575248425054E+00)
  # gamma3 = SVector(0.0000000000000000E+00, 0.0000000000000000E+00, 0.0000000000000000E+00, 3.8206596925834606E-02, 2.0269983674711087E-01)
  # beta   = SVector(1.9348267477327255E-01, 7.5551683096112165E-01, 8.2355190792256527E-01, 7.1667892331928801E-02, 4.2036847600483940E-01)
  # delta  = SVector(1.0000000000000000E+00, 3.7468643533635104E-02, -6.5985040871897271E-02, 1.0952340908518357E+00, 0.0000000000000000E+00)
  # # 7 stages, order 2
