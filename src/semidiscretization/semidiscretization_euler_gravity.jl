...
@muladd begin
    ...
    struct SemidiscretizationEulerGravity{
        ...
        function SemidiscretizationEulerGravity{SemiEuler, SemiGravity, Parameters, Cache}(
            ...
            new(
                semi_euler, semi_gravity, parameters, performance_counter, gravity_counter,
                cache
            )
        end
    end
    ...
    function SemidiscretizationEulerGravity(
        ...
        SemidiscretizationEulerGravity{
            typeof(semi_euler), typeof(semi_gravity),
            typeof(parameters), typeof(cache),
        }(
            semi_euler,
            semi_gravity,
            parameters, cache
    ...
    function update_gravity!(semi::SemidiscretizationEulerGravity, u_ode)
        ...
        while !finalstep
            ...
            if n_iterations_max > 0 && iter >= n_iterations_max
                @warn "Max iterations reached: Gravity solver failed to converge!" residual = maximum(
                    abs,
                    @views du_gravity[
                        1,
                        ..,
    ...
    function timestep_gravity_2N!(
            cache, u_euler, t, dt, gravity_parameters, semi_gravity,
            a, b, c
        )
    ...
    function timestep_gravity_carpenter_kennedy_erk54_2N!(
        ...
        timestep_gravity_2N!(
            cache, u_euler, t, dt, gravity_parameters, semi_gravity, a, b,
            c
        )
    end
    ...
    function timestep_gravity_3Sstar!(
            cache, u_euler, t, dt, gravity_parameters,
            semi_gravity,
    ...
    function timestep_gravity_erk51_3Sstar!(
        ...
        # 5 stages, order 1
        gamma1 = SVector(
            0.0e+0, 5.2910412316555866e-1,
            2.8433964362349406e-1, -1.4467571130907027e+0,
            7.5592215948661057e-2
        )
        gamma2 = SVector(
            1.0e+0, 2.6366970460864109e-1,
            3.7423646095836322e-1, 7.8786901832431289e-1,
            3.7754129043053775e-1
        )
        gamma3 = SVector(
            0.0e+0, 0.0e+0,
            0.0e+0, 8.0043329115077388e-1,
            1.3550099149374278e-1
        )
        beta = SVector(
            1.9189497208340553e-1, 5.4506406707700059e-2,
            1.2103893164085415e-1, 6.8582252490550921e-1,
            8.7914657211972225e-1
        )
        delta = SVector(
            1.0e+0, 7.8593091509463076e-1,
            1.263903871745484e-1, 1.7726945920209813e-1,
            0.0e+0
        )
        c = SVector(
            0.0e+0, 1.9189497208340553e-1, 1.9580448818599061e-1,
            2.4241635859769023e-1, 5.0728347557552977e-1
        )
    ...
    function timestep_gravity_erk52_3Sstar!(
        ...
        c = SVector(
            0.0e+0, 4.5158640252832094e-1, 1.0221535725056414e+0,
            1.4280257701954349e+0, 7.1581334196229851e-1
        )
    ...
    function timestep_gravity_erk53_3Sstar!(
        ...
        # 5 stages, order 3
        gamma1 = SVector(
            0.0e+0, 6.936220805401121e-1,
            9.1364483229179472e-1, 1.3129305757628569e+0,
            -1.4615811339132949e+0
        )
        gamma2 = SVector(
            1.0e+0, 1.3224582239681788e+0,
            2.4213162353103135e-1, -3.8532017293685838e-1,
            1.5603355704723714e+0
        )
        gamma3 = SVector(
            0.0e+0, 0.0e+0,
            0.0e+0, 3.8306787039991996e-1,
            -3.568312120171101e-1
        )
        beta = SVector(
            8.4476964977404881e-2, 3.0834660698015803e-1,
            3.2131664733089232e-1, 2.8783574345390539e-1,
            8.2199204703236073e-1
        )
        delta = SVector(
            1.0e+0, -7.6832695815481578e-1,
            1.2497251501714818e-1, 1.4496404749796306e+0,
            0.0e+0
        )
        c = SVector(
            0.0e+0, 8.4476964977404881e-2, 2.8110631488732202e-1,
            5.7093842145029405e-1, 7.2999896418559662e-1
        )
    ...
    @inline function (amr_callback::AMRCallback)(
        ...
        amr_callback(
            u_ode, mesh_equations_solver_cache(semi.semi_euler)..., semi, t, iter;
