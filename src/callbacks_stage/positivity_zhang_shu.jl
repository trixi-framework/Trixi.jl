...
@muladd begin
    ...
    function (limiter!::PositivityPreservingLimiterZhangShu)(
        ...
        @trixi_timeit timer() "positivity-preserving limiter" begin
            limiter_zhang_shu!(
                u, limiter!.thresholds, limiter!.variables,
    ...
    function limiter_zhang_shu!(
            u, thresholds::NTuple{N, <:Real}, variables::NTuple{N, Any},
        ...
        limiter_zhang_shu!(
            u, remaining_thresholds, remaining_variables, mesh, equations,
            solver, cache
        )
        return nothing
    end
    ...
    function limiter_zhang_shu!(
            u, thresholds::Tuple{}, variables::Tuple{},
            mesh, equations, solver, cache
        )
        nothing
    end
