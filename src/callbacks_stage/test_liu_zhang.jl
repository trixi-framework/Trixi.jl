...
Trixi.global_cell_average_limiter!(global_limiter!.cell_averages,
...
using Test
@test global_limiter!.cell_averages ≈
      SVector.([1.1722191699202247
                1.4358800215443228
                1.4358398499238705
                1.1721221870493048
                1.0e-6
...
@btime Trixi.global_cell_average_limiter!($(global_limiter!.cell_averages),
                                         $(global_limiter!.davis_yin_z),
                                         $(global_limiter!.projected_cell_averages),
                                         $(local_limiter!.thresholds), # TODO: generalize to multiple variables
                                         $(global_limiter!.pseudo_inverse_cell_volumes_vector),
