...
@muladd begin
    ...
    function (limiter!::SubcellLimiterIDPCorrection)(
            u_ode,
        ...
        semi = integrator.p
        limiter!(
            u_ode, semi, integrator.t, integrator.dt,
    ...
    function (limiter!::SubcellLimiterIDPCorrection)(
        ...
        @trixi_timeit timer() "a posteriori limiter" limiter!(
            u_ode, semi, t, dt,
    ...
    function (limiter!::SubcellLimiterIDPCorrection)(
        ...
        @trixi_timeit timer() "blending factors" solver.volume_integral.limiter(
            u, semi,
            solver, t,
            dt
        )
