...
"""
    Trixi.set_threading_backend!(backend::String; force = true)

Toggle and/or switch backend behavior used in multithreaded loops inside Trixi.jl.
By default, [Polyester.jl](https://github.com/JuliaSIMD/Polyester.jl) is enabled, but it can
...
"""
function set_threading_backend!(backend::String = "polyester"; force = true)
