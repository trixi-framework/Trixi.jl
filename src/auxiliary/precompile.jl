...
function _precompile_manual_()
    ...
    for RealT in (Int, Float64)
        @assert Base.precompile(
            Tuple{
                ...
                NamedTuple{
                    (:initial_refinement_level, :n_cells_max),
                    Tuple{Int, Int},
                }, Type{TreeMesh}, RealT,
                RealT,
            }
    ...
    for RealT in (Float64,)
        ...
        @assert Base.precompile(
            Tuple{
                Type{LinearScalarAdvectionEquation2D},
                Tuple{RealT, RealT},
            }
        )
        @assert Base.precompile(
            Tuple{
                Type{LinearScalarAdvectionEquation3D}, RealT, RealT,
                RealT,
            }
        )
        @assert Base.precompile(
            Tuple{
                Type{LinearScalarAdvectionEquation3D},
                Tuple{RealT, RealT, RealT},
            }
        )
    end
    ...
    for RealT in (Float64,)
        ...
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.calc_dhat), Vector{RealT},
                Vector{RealT},
            }
        )
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.calc_dsplit), Vector{RealT},
                Vector{RealT},
            }
        )
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.polynomial_derivative_matrix),
                Vector{RealT},
            }
        )
        @assert Base.precompile(
        ...
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.calc_lhat), RealT, Vector{RealT},
                Vector{RealT},
            }
        )
        @assert Base.precompile(
        ...
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.legendre_polynomial_and_derivative), Int,
                RealT,
            }
        )
    ...
    @assert Base.precompile(
        Tuple{
            typeof(Trixi.calc_reverse_upper), Int,
            Val{:gauss_lobatto},
        }
    )
    @assert Base.precompile(
        Tuple{
            typeof(Trixi.calc_reverse_lower), Int,
            Val{:gauss_lobatto},
        }
    )
    ...
    @assert Base.precompile(
        Tuple{
            typeof(summary_box), Base.TTY, String,
    ...
    for RealT in (Float64,), polydeg in 1:7
        ...
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.init_boundaries), Array{Int, 1},
        ...
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.init_interfaces), Array{Int, 1},
                TreeMesh{1, Trixi.SerialTree{1}},
                Trixi.ElementContainer1D{RealT, uEltype},
            }
        )
        ...
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.init_mortars), Array{Int, 1},
                TreeMesh{2, Trixi.SerialTree{2}},
                Trixi.ElementContainer2D{RealT, uEltype},
                mortar_type,
            }
        ...
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.init_mpi_interfaces), Array{Int, 1},
                TreeMesh{2, Trixi.ParallelTree{2}},
                Trixi.ElementContainer2D{RealT, uEltype},
            }
        )
    ...
    for RealT in (Float64,)
        ...
        for NDIMS in 1:3
            ...
            @assert Base.precompile(
                Tuple{
                    typeof(show), Base.TTY,
                    TreeMesh{NDIMS, Trixi.SerialTree{NDIMS}},
                }
            )
            @assert Base.precompile(
                Tuple{
                    typeof(show), IOContext{Base.TTY},
                    MIME"text/plain",
                    TreeMesh{NDIMS, Trixi.SerialTree{NDIMS}},
                }
            )
        ...
        @assert Base.precompile(
            Tuple{
                typeof(show), IOContext{Base.TTY}, MIME"text/plain",
        ...
        restart_callback_type = DiscreteCallback{
            SaveRestartCallback, SaveRestartCallback,
            typeof(Trixi.initialize!),
            typeof(SciMLBase.FINALIZE_DEFAULT),
        }
