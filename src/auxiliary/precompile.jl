  ...
  function _precompile_manual_()
    ...
    for TreeType in (SerialTree, ParallelTree), NDIMS in 1:3
      @assert Base.precompile(Tuple{typeof(Trixi.initialize!),
                                    TreeMesh{NDIMS, TreeType{NDIMS}}, Int, Tuple{}, Tuple{}
                                    })
    ...
    for RealT in (Float64,)
      ...
      @assert Base.precompile(Tuple{typeof(Trixi.calc_lhat), RealT, Vector{RealT},
                                    Vector{RealT}})
      @assert Base.precompile(Tuple{typeof(Trixi.lagrange_interpolating_polynomials), RealT,
                                    Vector{RealT}, Vector{RealT}})
    ...
    @assert Base.precompile(Tuple{typeof(summary_box), typeof(stdout), String,
    ...
    for RealT in (Float64,)
      ...
      for NDIMS in 1:3
        # serial
        @assert Base.precompile(Tuple{typeof(show), typeof(stdout),
                                      TreeMesh{NDIMS, Trixi.SerialTree{NDIMS}}})
        @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                      MIME"text/plain",
                                      TreeMesh{NDIMS, Trixi.SerialTree{NDIMS}}})
        # parallel
        @assert Base.precompile(Tuple{typeof(show), typeof(stdout),
      ...
      for polydeg in 1:1
        ...
        @assert Base.precompile(Tuple{typeof(show), typeof(stdout),
                                      DG{basis_type, mortar_type,
                                         typeof(flux_lax_friedrichs), VolumeIntegralWeakForm
                                         }})
        @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                      MIME"text/plain",
                                      DG{basis_type, mortar_type,
      ...
      # semidiscretizations
      @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                    MIME"text/plain", SemidiscretizationHyperbolic})
      ...
      @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                    MIME"text/plain", summary_callback_type})
      ...
      @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                    MIME"text/plain", alive_callback_type})
      ...
      @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                    MIME"text/plain", restart_callback_type})
      ...
      @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                    MIME"text/plain", stepsize_callback_type})
      ...
      @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                    MIME"text/plain", glm_speed_callback_type})
      ...
      @assert Base.precompile(Tuple{typeof(show), IOContext{typeof(stdout)},
                                    MIME"text/plain", lbm_collision_callback_type})
