...
@muladd begin
    ...
    function StructuredMeshView(
        ...
        return StructuredMeshView{NDIMS, RealT}(
            parent, cells_per_dimension, mapping,
            mapping_as_string,
    ...
    function save_mesh_file(
            mesh::StructuredMeshView, output_directory; system = "",
            timestep = 0
        )
