...
@muladd begin
    ...
    """
    mutable struct UnstructuredMesh2D{
            RealT <: Real,
    ...
    function UnstructuredMesh2D(
            filename; RealT = Float64, periodicity = false,
        ...
        n_boundaries = parse_mesh_file!(
            arrays, RealT, CurvedSurfaceT, file_lines, counters,
        ...
        for j in 1:n_elements
            ...
            if sum(curved_check) == 0
                ...
                for i in 1:4
                    ...
                    surface_curves[i, j] = CurvedSurfaceT(
                        cheby_nodes, bary_weights,
                        copy(curve_values)
                    )
