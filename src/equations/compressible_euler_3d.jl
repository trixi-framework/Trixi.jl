...
@doc raw"""
    pressure(u, equations::CompressibleEulerEquations3D)
...
@doc raw"""
    density_pressure(u, equations::CompressibleEulerEquations3D)
...
computing [`pressure(u, equations::CompressibleEulerEquations3D)`](@ref) first and 
