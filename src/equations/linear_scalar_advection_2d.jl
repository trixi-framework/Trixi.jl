...
# @inline function max_abs_speed_naive(u_ll, u_rr, orientation::Integer, equation::CouplingLinearScalarAdvectionEquation2D)
#   λ_max = abs(equation.coupling_strength)
# end

# @inline function max_abs_speeds(equation::CouplingLinearScalarAdvectionEquation2D)
...
# # Convert conservative variables to primitive
# @inline cons2prim(u, equation::CouplingLinearScalarAdvectionEquation2D) = u

# # Convert conservative variables to entropy variables
# @inline cons2entropy(u, equation::CouplingLinearScalarAdvectionEquation2D) = u

# # Calculate entropy for a conservative state `cons`
# @inline entropy(u::Real, ::CouplingLinearScalarAdvectionEquation2D) = 0.5 * u^2
# @inline entropy(u, equation::CouplingLinearScalarAdvectionEquation2D) = entropy(u[1], equation)

# # Calculate total energy for a conservative state `cons`
# @inline energy_total(u::Real, ::CouplingLinearScalarAdvectionEquation2D) = 0.5 * u^2
# @inline energy_total(u, equation::CouplingLinearScalarAdvectionEquation2D) = energy_total(u[1], equation)
...
varnames(::typeof(cons2cons), ::CouplingLinearScalarAdvectionEquation2D) = ("scalar", )
varnames(::typeof(cons2prim), ::CouplingLinearScalarAdvectionEquation2D) = ("scalar", )
...
# Set initial conditions at physical location `x` for time `t`
"""
    initial_condition_constant(x, t, equations::CouplingLinearScalarAdvectionEquation2D)

A constant initial condition to test free-stream preservation.
"""
function initial_condition_constant(x, t, equation::CouplingLinearScalarAdvectionEquation2D)
  # Store translated coordinate for easy use of exact solution
  x_trans = x_trans_periodic_2d(x - equation.advection_velocity * t)
...
"""
    initial_condition_convergence_test(x, t, equations::CouplingLinearScalarAdvectionEquation2D)

A smooth initial condition used for convergence tests.
"""
function initial_condition_convergence_test(x, t, equation::CouplingLinearScalarAdvectionEquation2D)
  # Store translated coordinate for easy use of exact solution
  x_trans = x - equation.advection_velocity * t
...
"""
    initial_condition_gauss(x, t, equation::CouplingLinearScalarAdvectionEquation2D)

A Gaussian pulse used together with
[`BoundaryConditionDirichlet(initial_condition_gauss)`](@ref).
"""
function initial_condition_gauss(x, t, equation::CouplingLinearScalarAdvectionEquation2D)
  # Store translated coordinate for easy use of exact solution
  x_trans = x_trans_periodic_2d(x - equation.advection_velocity * t)
...
"""
    initial_condition_sin_sin(x, t, equations::CouplingLinearScalarAdvectionEquation2D)

A sine wave in the conserved variable.
"""
function initial_condition_sin_sin(x, t, equation::CouplingLinearScalarAdvectionEquation2D)
  # Store translated coordinate for easy use of exact solution
  x_trans = x - equation.advection_velocity * t
...
"""
    initial_condition_linear_x_y(x, t, equations::CouplingLinearScalarAdvectionEquation2D)

A linear function of `x[1] + x[2]` used together with
[`boundary_condition_linear_x_y`](@ref).
"""
function initial_condition_linear_x_y(x, t, equation::CouplingLinearScalarAdvectionEquation2D)
  # Store translated coordinate for easy use of exact solution
  x_trans = x - equation.advection_velocity * t
...
"""
    boundary_condition_linear_x_y(u_inner, orientation, direction, x, t,
                                  surface_flux_function,
                                  equation::CouplingLinearScalarAdvectionEquation2D)
...
"""
    initial_condition_linear_x(x, t, equations::CouplingLinearScalarAdvectionEquation2D)

A linear function of `x[1]` used together with
[`boundary_condition_linear_x`](@ref).
"""
function initial_condition_linear_x(x, t, equation::CouplingLinearScalarAdvectionEquation2D)
  # Store translated coordinate for easy use of exact solution
  x_trans = x - equation.advection_velocity * t
...
"""
    initial_condition_linear_y(x, t, equations::CouplingLinearScalarAdvectionEquation2D)

A linear function of `x[1]` used together with
[`boundary_condition_linear_y`](@ref).
"""
function initial_condition_linear_y(x, t, equation::CouplingLinearScalarAdvectionEquation2D)
  # Store translated coordinate for easy use of exact solution
  x_trans = x - equation.advection_velocity * t
...
# Pre-defined source terms should be implemented as
# function source_terms_WHATEVER(u, x, t, equations::CouplingLinearScalarAdvectionEquation2D)
