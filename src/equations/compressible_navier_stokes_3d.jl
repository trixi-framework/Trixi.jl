...
```
"""
struct CompressibleNavierStokesVarMuDiffusion3D{GradientVariables, RealT <: Real,
                                                E <:
...
# default to primitive gradient variables
function CompressibleNavierStokesVarMuDiffusion3D(equations::CompressibleEulerEquations3D;
...
function varnames(variable_mapping,
                  equations_parabolic::Union{CompressibleNavierStokesDiffusion3D,
...
function gradient_variable_transformation(::Union{CompressibleNavierStokesDiffusion3D{GradientVariablesPrimitive},
                                                  CompressibleNavierStokesVarMuDiffusion3D{GradientVariablesPrimitive}})
    cons2prim
end
function gradient_variable_transformation(::Union{CompressibleNavierStokesDiffusion3D{GradientVariablesEntropy},
                                                  CompressibleNavierStokesVarMuDiffusion3D{GradientVariablesEntropy}})
    cons2entropy
end
...
function flux(u, gradients, orientation::Integer,
              equations::CompressibleNavierStokesVarMuDiffusion3D)
    # Here, `u` is assumed to be the "transformed" variables specified by `gradient_variable_transformation`.
    rho, v1, v2, v3, _ = convert_transformed_to_primitive(u, equations)
    # Here `gradients` is assumed to contain the gradients of the primitive variables (rho, v1, v2, v3, T)
    # either computed directly or reverse engineered from the gradient of the entropy variables
...
@inline function convert_transformed_to_primitive(u_transformed,
                                                  equations::Union{CompressibleNavierStokesDiffusion3D{GradientVariablesPrimitive},
                                                                   CompressibleNavierStokesVarMuDiffusion3D{GradientVariablesPrimitive}})
...
@inline function convert_transformed_to_primitive(u_transformed,
                                                  equations::Union{CompressibleNavierStokesDiffusion3D{GradientVariablesEntropy},
                                                                   CompressibleNavierStokesVarMuDiffusion3D{GradientVariablesEntropy}})
