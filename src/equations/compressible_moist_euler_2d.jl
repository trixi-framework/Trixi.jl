...
function solve_for_absolute_temperature(moist_state, H, equations, T_0)
  @unpack p_0, c_pd, c_pv = equations
  @unpack theta_e, p_d, r_v, L_v = moist_state
...
function inital_condition_moist_bubble(x, t, equations::CompressibleMoistEulerEquations2D)
