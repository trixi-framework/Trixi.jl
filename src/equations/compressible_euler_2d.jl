...
@inline function pressure_gradient_conservative(u,
                                                equations::CompressibleEulerEquations2D)
    rho, rho_v1, rho_v2, rho_e = u
...
@inline function entropy_math_gradient_conservative(u,
                                                    equations::CompressibleEulerEquations2D)
...
# Transformation from conservative variables u to d(s)/d(u)
@inline function entropy_guermond_etal_gradient_conservative(u,
                                                             equations::CompressibleEulerEquations2D)
