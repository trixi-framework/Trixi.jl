...
@inline function min_max_speed_naive(u_ll, u_rr, normal_direction::AbstractVector,
    ...
    lambda_min = v_normal_ll - sqrt_(equations.gamma * p_ll / rho_ll) * norm_
    lambda_max = v_normal_rr + sqrt_(equations.gamma * p_rr / rho_rr) * norm_
...
@inline function max_abs_speeds(u, equations::PolytropicEulerEquations2D)
    rho, v1, v2 = cons2prim(u, equations)
    c = sqrt_(equations.gamma * equations.kappa * rho^(equations.gamma - 1))
