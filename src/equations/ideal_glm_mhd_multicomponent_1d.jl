...
get_name(::IdealGlmMhdMulticomponentEquations1D) = "IdealGlmMhdMulticomponentEquations1D"
...
function flux_lax_friedrichs(u_ll, u_rr, orientation, equations::IdealGlmMhdMulticomponentEquations1D)
