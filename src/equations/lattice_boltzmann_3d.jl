...
@muladd begin
    ...
    * 27 ←→ 27
    ...
    function LatticeBoltzmannEquations3D(;
            Ma, Re, collision_op = collision_bgk,
            c = 1, L = 1, rho0 = 1, u0 = nothing, nu = nothing
        )
        ...
        weights = SVector{27, RealT}(
            2 / 27, 2 / 27, 2 / 27, 2 / 27, 2 / 27, 2 / 27, 1 / 54,
            1 / 54,
            1 / 54,
        ...
        v_alpha1 = SVector{27, RealT}(
            c, -c, 0, 0, 0, 0, c, -c, c,
            -c, 0, 0, c, -c, c, -c, 0, 0,
            c, -c, c, -c, c, -c, -c, c, 0
        )
        v_alpha2 = SVector{27, RealT}(
            0, 0, c, -c, 0, 0, c, -c, 0,
            0, c, -c, -c, c, 0, 0, c, -c,
            c, -c, c, -c, -c, c, c, -c, 0
        )
        v_alpha3 = SVector{27, RealT}(
            0, 0, 0, 0, c, -c, 0, 0, c,
            -c, c, -c, 0, 0, -c, c, -c, c,
            c, -c, -c, c, c, -c, c, -c, 0
        )
