...
@doc raw"""
    jacobian_entropy2cons(w, equations::CompressibleEulerEquations1D)
...
"""
@inline function jacobian_entropy2cons(w, equations::CompressibleEulerEquations1D)
    ...
    return @SMatrix [rho rho_v1 rho_e
