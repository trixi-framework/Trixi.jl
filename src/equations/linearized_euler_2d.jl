...
@muladd begin
    ...
    function LinearizedEulerEquations2D(
        ...
        return LinearizedEulerEquations2D(
            SVector(v_mean_global), c_mean_global,
            rho_mean_global
        )
    end
    ...
    @inline function flux_godunov(
        ...
        f2p = (
            (
                (
                    lambda1_p * normal_vector[2]^2 +
                        lambda2p3_half_p * normal_vector[1]^2
                ) * v1_prime_ll +
        ...
        f3p = (
            (
                (
                    lambda1_p * normal_vector[1]^2 +
                        lambda2p3_half_p * normal_vector[2]^2
                ) * v2_prime_ll +
        ...
        f2m = (
            (
                (
                    lambda1_m * normal_vector[2]^2 +
                        lambda2p3_half_m * normal_vector[1]^2
                ) * v1_prime_rr +
        ...
        f3m = (
            (
                (
                    lambda1_m * normal_vector[1]^2 +
                        lambda2p3_half_m * normal_vector[2]^2
                ) * v2_prime_rr +
