...
@muladd begin
  ...
  \begin{aligned}
    \frac{\partial h_1}{\partial t} + \frac{\partial}{\partial x}(h_1 v_1) &= 0 \\
      ...
      \right) &= - g h_1 \frac{\partial}{\partial x}\left(b + h_2 \right) \\
      ...
      \right)&= - g h_2 \frac{\partial}{\partial x}\left(b + \frac{\rho_1}{\rho_2}h_1 \right)
  \end{aligned}
  ```
  ...
  * Trixi's visualization tools will visualize the bottom topography by default.
  ...
  varnames(::typeof(cons2cons), ::TwoLayerShallowWaterEquations1D) = ("h1", "h1_v1", "h2", "h2_v2", "b")
  ...
  @inline function source_terms_convergence_test(u, x, t, equations::TwoLayerShallowWaterEquations1D)
    ...
    du1 = -0.1cos(t + ω*x[1]) - 0.1sin(t + ω*x[1]) - 0.09000000000000001ω*cos(t + ω*x[1]) - 0.09000000000000001ω*sin(t + ω*x[1])
    du2 = 5.0(-0.1ω*cos(t + ω*x[1]) - 0.1ω*sin(t + ω*x[1]))*(4.0 + 0.2cos(t + ω*x[1]) - 0.2sin(t + ω*x[1])) + 0.1ω*(20.0 + cos(t + ω*x[1]) - sin(t + ω*x[1]))*cos(t + ω*x[1]) - 0.09000000000000001cos(t + ω*x[1]) - 0.09000000000000001sin(t + ω*x[1]) - 0.08100000000000002ω*cos(t + ω*x[1]) - 0.08100000000000002ω*sin(t + ω*x[1])
    du3 = 0.1cos(t + ω*x[1]) + 0.1ω*cos(t + ω*x[1]) + 0.2ω*sin(2ω*x[1])
    du4 = (10.0 + sin(t + ω*x[1]) - cos(2ω*x[1]))*(-0.09000000000000001ω*cos(t + ω*x[1]) - 0.09000000000000001ω*sin(t + ω*x[1]) - 0.2ω*sin(2ω*x[1])) + 0.1cos(t + ω*x[1]) + 0.1ω*cos(t + ω*x[1]) + 5.0(0.1ω*cos(t + ω*x[1]) + 0.2ω*sin(2ω*x[1]))*(2.0 + 0.2sin(t + ω*x[1]) - 0.2cos(2ω*x[1])) + 0.2ω*sin(2ω*x[1])
  ...
  @inline function energy_total(cons, equations::TwoLayerShallowWaterEquations1D)
    ...
    e = 0.5 * ρ1 * (h1_v1^2 / h1 + g * h1^2) + 0.5 * ρ2 * (h2_v2^2 / h2 + g * h2^2) + g * ρ2 * h2 * b + g * ρ1 * h1 * (h2 + b)
    return e
  end
