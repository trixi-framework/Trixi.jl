...
@muladd begin
    ...
    """
    mutable struct EulerAcousticsCouplingCallback{
            RealT <: Real, MeanValues,
            IntegratorEuler,
        }
    ...
    function Base.show(
        ...
        summary_line(
            io, "acoustics StepsizeCallback",
            euler_acoustics_coupling.stepsize_callback_acoustics
        )
        summary_line(
            io, "Euler StepsizeCallback",
    ...
    function EulerAcousticsCouplingCallback(
            ode_euler,
            averaging_callback::DiscreteCallback{
                <:Any,
                <:AveragingCallback,
            },
        ...
        return EulerAcousticsCouplingCallback(
            ode_euler, mean_values, alg, cfl_acoustics,
            cfl_euler;
            kwargs...
        )
    end
    ...
    """
    function EulerAcousticsCouplingCallback(
            ode_euler, averaging_file::AbstractString, alg,
            cfl_acoustics::Real, cfl_euler::Real; kwargs...
        )
    ...
    function EulerAcousticsCouplingCallback(
        ...
        return DiscreteCallback(
            condition, euler_acoustics_coupling,
    ...
    function (euler_acoustics_coupling::EulerAcousticsCouplingCallback)(integrator_acoustics)
        ...
        @trixi_timeit timer() "calc acoustic source terms" begin
            calc_acoustic_sources!(
                acoustic_source_terms, u_euler, u_acoustics,
