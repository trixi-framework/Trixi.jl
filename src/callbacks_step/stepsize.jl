...
function Base.show(io::IO, @nospecialize cb::DiscreteCallback{<:Any, <:StepsizeCallback})
  stepsize_callback = cb.affect!
  @unpack cfl_number = stepsize_callback
  print(io, "StepsizeCallback(cfl_number=", cfl_number, ")")
end

function Base.show(io::IO, ::MIME"text/plain", @nospecialize cb::DiscreteCallback{<:Any, <:StepsizeCallback})
