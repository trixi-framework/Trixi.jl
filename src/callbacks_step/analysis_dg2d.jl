...
function create_cache_analysis(analyzer, mesh::Union{CurvedMesh{2}, UnstructuredQuadMesh{2}},
                               equations::AbstractEquations{2}, dg::DG, cache,
                               RealT, uEltype)
  # pre-allocate buffers
  u_local = zeros(uEltype,
...
function calc_error_norms(func, u::AbstractArray{<:Any,4}, t, analyzer,
                          mesh::Union{CurvedMesh{2}, UnstructuredQuadMesh{2}}, equations,
...
function integrate(func::Func, u::AbstractArray{<:Any,4},
                   mesh::Union{TreeMesh{2},CurvedMesh{2},UnstructuredQuadMesh{2}}, equations, dg::DGSEM, cache; normalize=true) where {Func}
...
function analyze(::typeof(entropy_timederivative), du::AbstractArray{<:Any,4}, u, t,
                 mesh::Union{TreeMesh{2},CurvedMesh{2},UnstructuredQuadMesh{2}}, equations, dg::DG, cache)
