...
@muladd begin
    ...
    function refine!(
            u_ode::AbstractVector, adaptor, mesh::Union{TreeMesh{3}, P4estMesh{3}},
        ...
        GC.@preserve old_u_ode old_inverse_jacobian begin
            ...
            for old_element_id in 1:old_n_elements
                if needs_refinement[old_element_id]
                    ...
                    refine_element!(
                        u, element_id, old_u, old_element_id, adaptor,
    ...
    function refine_element!(
            u::AbstractArray{<:Any, 5}, element_id,
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, bottom_lower_left_id), forward_lower,
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, bottom_lower_right_id), forward_upper,
            forward_lower, forward_lower,
            view(old_u, :, :, :, :, old_element_id), u_tmp1, u_tmp2
        )
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, bottom_upper_left_id), forward_lower,
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, bottom_upper_right_id), forward_upper,
            forward_upper, forward_lower,
            view(old_u, :, :, :, :, old_element_id), u_tmp1, u_tmp2
        )
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, top_lower_left_id), forward_lower,
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, top_lower_right_id), forward_upper,
            forward_lower, forward_upper,
            view(old_u, :, :, :, :, old_element_id), u_tmp1, u_tmp2
        )
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, top_upper_left_id), forward_lower,
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, top_upper_right_id), forward_upper,
            forward_upper, forward_upper,
            view(old_u, :, :, :, :, old_element_id), u_tmp1, u_tmp2
        )
    ...
    function coarsen_elements!(
        ...
        multiply_dimensionwise!(
            view(u, :, :, :, :, element_id), reverse_lower,
        ...
        add_multiply_dimensionwise!(
            view(u, :, :, :, :, element_id), reverse_upper,
            reverse_lower, reverse_lower,
    ...
    function adapt!(
            u_ode::AbstractVector, adaptor, mesh::T8codeMesh{3}, equations,
        ...
        GC.@preserve old_u_ode begin
            ...
            while old_index <= old_nelems && new_index <= new_nelems
                if difference[old_index] > 0 # Refine.
                    ...
                    # Refine element and store solution directly in new data structure.
                    refine_element!(
                        u, new_index, old_u, old_index, adaptor, equations, dg,
                        u_tmp1, u_tmp2
                    )
                ...
                elseif difference[old_index] < 0 # Coarsen.
                    ...
                    # Coarsen elements and store solution directly in new data structure.
                    coarsen_elements!(
                        u, new_index, old_u, old_index, adaptor, equations,
                        dg, u_tmp1, u_tmp2
                    )
                    ...
                    for v in eachvariable(equations)
                        u[v, .., new_index] .*= (
                            8 .* cache.elements.inverse_jacobian[
                                ..,
                                new_index,
                            ]
                        )
