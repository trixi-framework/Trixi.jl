...
#! format: noindent
  ...
  function Base.show(io::IO, ::MIME"text/plain",
    ...
    if get(io, :compact, false)
      ...
      setup = [
        ...
        "save initial solution" => save_solution_callback.save_initial_solution ? "yes" :
                                   "no",
  ...
  function SaveSolutionCallback(; interval = 0,
                                ...
                                output_directory = "out",
                                solution_variables = cons2prim)
    solution_callback = SaveSolutionCallback(interval, save_initial_solution,
                                             save_final_solution,
  ...
  function initialize!(cb::DiscreteCallback{Condition, Affect!}, u, t,
                       integrator) where {Condition, Affect! <: SaveSolutionCallback}
    ...
    @trixi_timeit timer() "I/O" begin if mesh.unsaved_changes
