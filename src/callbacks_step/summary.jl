...
@muladd begin
    ...
    function summary_line(
            io, key, value; key_width = 30, total_width = 100,
            indentation_level = 0
        )
    ...
    function initialize_summary_callback(
            cb::DiscreteCallback, u, t, integrator;
            reset_threads = true
        )
    ...
    function (cb::DiscreteCallback{Condition, Affect!})(io::IO = stdout) where {
            Condition,
            Affect! <:
