...
@muladd begin
    ...
    mutable struct VisualizationCallback{
            SolutionVariables, VariableNames, PlotDataCreator,
            PlotCreator,
        }
        interval::Int
    ...
    function VisualizationCallback(;
        ...
        DiscreteCallback(
            visualization_callback, visualization_callback, # the first one is the condition, the second the affect!
