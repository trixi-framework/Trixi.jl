...
"""
    save_solution_file(u, time, dg, timestep, mesh::DGMultiMesh,
...
TBW
"""
function save_solution_file(u, time, dt, timestep, mesh::DGMultiMesh,
  ...
  h5open(filename, "w") do file
    ...
    attributes(file)["n_elements"] = mesh.md.num_elements
