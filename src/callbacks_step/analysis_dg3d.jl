...
@muladd begin
    ...
    function create_cache_analysis(
        ...
        return (;
            u_local, u_tmp1, u_tmp2, x_local, x_tmp1, x_tmp2, jacobian_local,
    ...
    function calc_error_norms(
        ...
        for element in eachelement(dg, cache)
            ...
            multiply_dimensionwise!(
                u_local, vandermonde, view(u, :, :, :, :, element),
                u_tmp1, u_tmp2
            )
            multiply_dimensionwise!(
                x_local, vandermonde,
    ...
    function integrate(
        ...
        integrate_via_indices(
            ...
            u_local = get_node_vars(u, equations, dg, i, j, k, element)
            gradients_1_local = get_node_vars(
                gradients_x, equations_parabolic, dg, i, j, k,
                element
            )
            gradients_2_local = get_node_vars(
                gradients_y, equations_parabolic, dg, i, j, k,
                element
            )
            gradients_3_local = get_node_vars(
                gradients_z, equations_parabolic, dg, i, j, k,
                element
            )
            return func(
                u_local, (gradients_1_local, gradients_2_local, gradients_3_local),
                equations_parabolic
            )
        end
    end
    ...
    function analyze(
            ::typeof(entropy_timederivative), du, u, t,
            mesh::Union{
                TreeMesh{3}, StructuredMesh{3}, P4estMesh{3},
                T8codeMesh{3},
            },
    ...
    function analyze(
        ...
        integrate_via_indices(
            u, mesh, equations, dg, cache, cache,
            dg.basis.derivative_matrix
        ) do u, i, j, k, element, equations,
