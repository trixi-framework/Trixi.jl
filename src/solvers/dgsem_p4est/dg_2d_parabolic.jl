...
function calc_boundary_flux_gradients!(cache, t,
                                       ...
                                       mesh::P4estMesh{2}, equations, surface_integral, dg::DG)
    @assert isempty(eachboundary(dg, cache))
end

# Function barrier for type stability
function calc_boundary_flux_gradients!(cache, t, boundary_conditions, mesh::P4estMesh{2},
...
function calc_boundary_flux_divergence!(cache, t, boundary_conditions, mesh::P4estMesh{2},
                                        equations, surface_integral, dg::DG)
    (; boundary_condition_types, boundary_indices) = boundary_conditions
...
function calc_boundary_flux_by_type!(cache, t, BCs::Tuple{}, BC_indices::Tuple{},
                                     operator_type, mesh::P4estMesh{2}, equations,
                                     surface_integral, dg::DG)
    nothing
end
