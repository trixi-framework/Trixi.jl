...
@muladd begin
    ...
    function init_element!(
            elements, element, basis::AbstractDerivativeOperator,
        ...
        calc_metric_terms!(
            elements.jacobian_matrix, element, basis,
        ...
        calc_normal_directions!(
            elements.normal_directions, element,
            elements.jacobian_matrix
        )
    ...
    function calc_metric_terms!(
            jacobian_matrix, element, D_SBP::AbstractDerivativeOperator,
            node_coordinates
        )
        ...
        for j in eachnode(D_SBP)
            mul!(
                view(jacobian_matrix, 1, 1, :, j, element), D_SBP,
        ...
        for j in eachnode(D_SBP)
            mul!(
                view(jacobian_matrix, 2, 1, :, j, element), D_SBP,
        ...
        for i in eachnode(D_SBP)
            mul!(
                view(jacobian_matrix, 1, 2, i, :, element), D_SBP,
        ...
        for i in eachnode(D_SBP)
            mul!(
                view(jacobian_matrix, 2, 2, i, :, element), D_SBP,
