...
const DGMultiFluxDiff{ApproxType,ElemType} = DGMulti{NDIMS,ElemType,ApproxType,
                                                     ...
                                                     <:Union{VolumeIntegralFluxDifferencing,
                                                             VolumeIntegralShockCapturingHG}} where {NDIMS}
...
const DGMultiSBP{ApproxType,ElemType} = DGMulti{NDIMS,ElemType,ApproxType,SurfaceIntegral,
...
function DGMultiMesh(dg::DGMulti, geometric_term_type, md::MeshData{NDIMS},
  ...
  return DGMultiMesh{NDIMS,typeof(geometric_term_type),typeof(md),typeof(boundary_faces)}(md,
                                                                                          boundary_faces)
end
