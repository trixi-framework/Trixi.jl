...
function init_elements(mesh::UnstructuredMesh2D, equations, basis::SummationByPartsOperators.UpwindOperators, RealT, uEltype)
...
function init_element!(elements, element, basis::LobattoLegendreBasis, corners_or_surface_curves)
  ...
  calc_metric_terms!(elements.jacobian_matrix, element, get_nodes(basis), corners_or_surface_curves)
  ...
  calc_normal_directions!(elements.normal_directions, element, get_nodes(basis), corners_or_surface_curves)
...
function init_interfaces(mesh::UnstructuredMesh2D, elements::Union{UnstructuredElementContainer2D, UpwindElementContainer2D})
...
function init_boundaries(mesh::UnstructuredMesh2D, elements::Union{UnstructuredElementContainer2D, UpwindElementContainer2D})
