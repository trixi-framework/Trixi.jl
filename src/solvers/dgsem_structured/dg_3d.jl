...
@muladd begin
  function rhs!(du, u, t,
    ...
    @trixi_timeit timer() "interface flux" calc_interface_flux!(cache, u, mesh,
                                                                have_nonconservative_terms(equations),
                                                                equations,
  ...
  @inline function weak_form_kernel!(du, u,
    ...
    for k in eachnode(dg), j in eachnode(dg), i in eachnode(dg)
      ...
      for ii in eachnode(dg)
        multiply_add_to_node_vars!(du, alpha * derivative_dhat[ii, i], contravariant_flux1,
      ...
      for jj in eachnode(dg)
        multiply_add_to_node_vars!(du, alpha * derivative_dhat[jj, j], contravariant_flux2,
      ...
      for kk in eachnode(dg)
        multiply_add_to_node_vars!(du, alpha * derivative_dhat[kk, k], contravariant_flux3,
      ...
      for i in 2:nnodes(dg)
        ...
        for m in 1:nnodes(dg)
          normal_direction += weights[i - 1] * derivative_matrix[i - 1, m] *
                              get_contravariant_vector(1, contravariant_vectors, m, j, k,
                                                       element)
        end
      ...
      for j in 2:nnodes(dg)
        ...
        for m in 1:nnodes(dg)
          normal_direction += weights[j - 1] * derivative_matrix[j - 1, m] *
                              get_contravariant_vector(2, contravariant_vectors, i, m, k,
                                                       element)
        end
      ...
      for k in 2:nnodes(dg)
        ...
        for m in 1:nnodes(dg)
          normal_direction += weights[k - 1] * derivative_matrix[k - 1, m] *
                              get_contravariant_vector(3, contravariant_vectors, i, j, m,
                                                       element)
        end
  ...
  @inline function calcflux_fv!(fstar1_L, fstar1_R, fstar2_L, fstar2_R, fstar3_L, fstar3_R,
    ...
    for k in eachnode(dg), j in eachnode(dg)
      ...
      for i in 2:nnodes(dg)
        ...
        ftilde_L = ftilde +
                   0.5 *
                   nonconservative_flux(u_ll, u_rr, normal_direction, normal_direction,
                                        equations)
        ftilde_R = ftilde +
                   0.5 *
                   nonconservative_flux(u_rr, u_ll, normal_direction, normal_direction,
                                        equations)
