...
@generated function flux_differencing_kernel_turbo!(_du::PtrArray, u_cons::PtrArray,
    ...
    cons2aux = Expr(:(=), Expr(:tuple, [Symbol(:aux_, v) for v in 1:NAUX]...),
                    :(cons2fluxauxiliary(volume_turbo_flux_function, $(cons_reads...),
                                         equations)))
...
@inline function turbo_volume_flux(volume_flux::typeof(flux_ranocha_turbo),
