...
function rhs!(dg::Dg3D, t_stage)
  ...
  # Apply positivity preserving limiter of Zhang and Shu
  @timeit_debug timer() "positivity preserving limiter" apply_positivity_preserving_limiter!(dg)
  ...
  @timeit_debug timer() "prolong2mortars" prolong2mortars!(dg)

  # Calculate mortar fluxes
  @timeit_debug timer() "mortar flux" calc_mortar_flux!(dg)
