        ...
        for direction in eachdirection(mesh.tree)
            ...
            for element in eachelement(elements)
                ...
                elseif direction == 2 # +x direction
                    boundaries.node_coordinates[:, :, :, count] .= enc[
                        :, end, :, :,
                        element,
                    ]
        ...
        for element in eachelement(elements)
            ...
            for direction in eachdirection(mesh.tree)
                ...
                if direction == 1 # -x
                    ...
                    mortars.neighbor_ids[3, count] = c2e[
                        mesh.tree.child_ids[
                            6,
                            neighbor_cell_id,
                        ],
                    ]
                    mortars.neighbor_ids[4, count] = c2e[
                        mesh.tree.child_ids[
                            8,
                            neighbor_cell_id,
                        ],
