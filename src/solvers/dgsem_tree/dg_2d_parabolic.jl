...
function prolong2interfaces!(cache, flux_parabolic::Tuple,
    ...
    @threaded for interface in eachinterface(dg, cache)
        ...
        if orientations[interface] == 1
            ...
            @trixi_bounds for j in eachnode(dg), v in eachvariable(equations_parabolic)
            ...
            @trixi_bounds for i in eachnode(dg), v in eachvariable(equations_parabolic)
    ...
    @threaded for interface in eachinterface(dg, cache)
        ...
        if orientations[interface] == 1
            ...
            @trixi_bounds for j in eachnode(dg)
                @trixi_bounds for v in eachvariable(equations_parabolic)
