...
@muladd begin
    ...
    function create_cache(
        ...
        fstar1_L_threaded = A2dp1_x[
            A2dp1_x(undef, nvariables(equations), nnodes(dg) + 1)
...
=#
    ...
    function calc_volume_integral!(
        ...
        @threaded for element in eachelement(dg, cache)
            flux_differencing_kernel!(
                du, u, element, mesh, nonconservative_terms,
                equations,
    ...
    @inline function fv_kernel!(
        ...
        calcflux_fv!(
            fstar1_L, fstar1_R, u, mesh, nonconservative_terms, equations,
            volume_flux_fv,
            dg, element, cache
        )
    ...
    @inline function calcflux_fv!(
            fstar1_L, fstar1_R, u::AbstractArray{<:Any, 3},
            mesh::Union{TreeMesh{1}, StructuredMesh{1}},
    ...
    function calc_boundary_flux_by_direction!(
        ...
        @threaded for boundary in first_boundary:last_boundary
            ...
            noncons_flux = boundary_condition(
                u_inner, orientations[boundary], direction, x,
    ...
    function calc_surface_integral!(
            du, u, mesh::Union{TreeMesh{1}, StructuredMesh{1}},
    ...
    function apply_jacobian!(
            du, mesh::Union{TreeMesh{1}, StructuredMesh{1}},
