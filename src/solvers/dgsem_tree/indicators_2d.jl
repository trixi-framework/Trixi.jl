...
function (indicator_hg::IndicatorHennemannGassner)(u::AbstractArray{<:Any,4}, mesh::Union{UnstructuredMesh2D},
                                                   equations, dg::DGSEM, cache;
                                                   kwargs...)
  @unpack alpha_max, alpha_min, alpha_smooth, variable = indicator_hg
  @unpack alpha, alpha_tmp, indicator_threaded, modal_threaded, modal_tmp1_threaded = indicator_hg.cache
...
function (indicator_hg::IndicatorHennemannGassner)(u::AbstractArray{<:Any,4}, mesh::Union{StructuredMesh{2}},
                                                   equations, dg::DGSEM, cache;
                                                   kwargs...)
  @unpack alpha_max, alpha_min, alpha_smooth, variable = indicator_hg
  @unpack alpha, alpha_tmp, indicator_threaded, modal_threaded, modal_tmp1_threaded = indicator_hg.cache
