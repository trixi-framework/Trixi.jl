mutable struct ViscousContainer1D{uEltype <: Real}
    ...
    function ViscousContainer1D{uEltype}(
...
function init_viscous_container_1d(
        n_vars::Integer, n_nodes::Integer,
        n_elements::Integer,
        ::Type{uEltype}
    ) where {uEltype <: Real}
...
function Base.resize!(viscous_container::ViscousContainer1D, equations, dg, cache)
    ...
    viscous_container.gradients = unsafe_wrap(
        Array,
    ...
    viscous_container.flux_viscous = unsafe_wrap(
        Array,
