...
function rhs_parabolic!(du, u, t, mesh::Union{P4estMesh{3},TreeMesh{3}},
...
function calc_viscous_fluxes!(flux_viscous, gradients, u_transformed, mesh::Union{P4estMesh{3},TreeMesh{3}},
                              equations_parabolic::AbstractEquationsParabolic,
...
function apply_jacobian_parabolic!(du, mesh::Union{P4estMesh{3},TreeMesh{3}},
