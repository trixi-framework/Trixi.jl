...
@muladd begin
    ...
    function Base.show(io::IO, ::MIME"text/plain", basis::LobattoLegendreBasis)
        ...
        print(
            io, "LobattoLegendreBasis{", real(basis), "} with polynomials of degree ",
            polydeg(basis)
        )
    end
    ...
    @inline function nnodes(basis::LobattoLegendreBasis{RealT, NNODES}) where {
            RealT, NNODES,
        }
        NNODES
    end
    ...
    function MortarL2(basis::LobattoLegendreBasis)
        ...
        LobattoLegendreMortarL2{
            RealT, nnodes_, typeof(forward_upper),
    ...
    function Base.show(io::IO, mortar::LobattoLegendreMortarL2)
        ...
        print(
            io, "LobattoLegendreMortarL2{", real(mortar), "}(polydeg=", polydeg(mortar),
            ")"
        )
    end
    function Base.show(io::IO, ::MIME"text/plain", mortar::LobattoLegendreMortarL2)
        ...
        print(
            io, "LobattoLegendreMortarL2{", real(mortar), "} with polynomials of degree ",
            polydeg(mortar)
        )
    end
    ...
    @inline function nnodes(mortar::LobattoLegendreMortarL2{RealT, NNODES}) where {
            RealT,
            NNODES,
        }
        NNODES
    ...
    function Base.show(io::IO, analyzer::LobattoLegendreAnalyzer)
        ...
        print(
            io, "LobattoLegendreAnalyzer{", real(analyzer), "}(polydeg=",
            polydeg(analyzer), ")"
        )
    end
    function Base.show(io::IO, ::MIME"text/plain", analyzer::LobattoLegendreAnalyzer)
        ...
        print(
            io, "LobattoLegendreAnalyzer{", real(analyzer),
    ...
    @inline function nnodes(analyzer::LobattoLegendreAnalyzer{RealT, NNODES}) where {
            RealT,
            NNODES,
        }
        NNODES
    ...
    function Base.show(io::IO, adaptor::LobattoLegendreAdaptorL2)
        ...
        print(
            io, "LobattoLegendreAdaptorL2{", real(adaptor), "}(polydeg=",
            polydeg(adaptor), ")"
        )
    end
    ...
    @inline function nnodes(adaptor::LobattoLegendreAdaptorL2{RealT, NNODES}) where {
            RealT,
            NNODES,
        }
        NNODES
