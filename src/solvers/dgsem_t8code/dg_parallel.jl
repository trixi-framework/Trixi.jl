@muladd begin
    ...
    function create_cache(
            mesh::ParallelT8codeMesh, equations::AbstractEquations, dg::DG,
            ::Any,
            ::Type{uEltype}
        ) where {uEltype <: Real}
        ...
        mpi_cache = init_mpi_cache(
            mesh, mpi_mesh_info, nvariables(equations), nnodes(dg),
            uEltype
        )
    ...
    function init_mpi_cache!(
            mpi_cache::P4estMPICache, mesh::ParallelT8codeMesh,
