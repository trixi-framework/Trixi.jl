...
@muladd begin
        ...
        for itree in 0:(num_local_trees - 1)
            ...
            for ielement in 0:(num_elements_in_tree - 1)
                ...
                polynomial_interpolation_matrix!(
                    matrix1, mesh.nodes, nodes_out_x,
                    baryweights_in
                )
                polynomial_interpolation_matrix!(
                    matrix2, mesh.nodes, nodes_out_y,
                    baryweights_in
                )
                polynomial_interpolation_matrix!(
                    matrix3, mesh.nodes, nodes_out_z,
                    baryweights_in
                )
    ...
    function init_mortar_neighbor_ids!(
        ...
        if !flipped
            ...
            elseif (
                    (lower && orientation == 2) # Corner 0 of my side matches corner 2 of other side
                        ||
                        (!lower && orientation == 1)
            ...
            elseif (
                    (lower && orientation == 1) # Corner 0 of my side matches corner 1 of other side
                        ||
                        (!lower && orientation == 2)
