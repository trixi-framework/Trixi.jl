...
@muladd begin
    ...
    struct SimpleSSPRK33{StageCallbacks} <: SimpleAlgorithmSSP
        ...
        function SimpleSSPRK33(; stage_callbacks = ())
            ...
            new{typeof(stage_callbacks)}(
                numerator_a, numerator_b, denominator, c,
                stage_callbacks
            )
        end
    end
    ...
    function SimpleIntegratorSSPOptions(callback, tspan; maxiters = typemax(Int), kwargs...)
        ...
        SimpleIntegratorSSPOptions{typeof(callback), typeof(tstops_internal)}(
            callback,
            false, Inf,
            maxiters,
            tstops_internal
    ...
    mutable struct SimpleIntegratorSSP{
    ...
    """
    function solve(
            ode::ODEProblem, alg = SimpleSSPRK33()::SimpleAlgorithmSSP;
        ...
        integrator = SimpleIntegratorSSP(
            u, du, r0, t, tdir, dt, dt, iter, ode.p,
            (prob = ode,), ode.f, alg,
            SimpleIntegratorSSPOptions(
                callback, ode.tspan;
                kwargs...
    ...
    function solve!(integrator::SimpleIntegratorSSP)
        ...
        @trixi_timeit timer() "main loop" while !integrator.finalstep
            ...
            for stage in eachindex(alg.c)
                ...
                @. integrator.u = (
                    alg.numerator_a[stage] * integrator.r0 +
