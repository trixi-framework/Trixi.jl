...
@doc raw"""
    ...
    - `dt_opt` (`Float64`): The optimal time step size that must be supplied when using the first constructor with A-matrix coefficients, 
       unlike the second or third constructors which calculate it automatically.
