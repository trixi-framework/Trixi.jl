...
"""
mutable struct P4estMesh{NDIMS, RealT<:Real, P, NDIMSP2} <: AbstractMesh{NDIMS}
  ...
  function P4estMesh{NDIMS}(p4est, tree_node_coordinates, nodes, boundary_names,
    ...
    mesh = new{NDIMS, eltype(tree_node_coordinates), typeof(p4est), NDIMS+2}(p4est,
      tree_node_coordinates, nodes, boundary_names, current_filename, unsaved_changes)
